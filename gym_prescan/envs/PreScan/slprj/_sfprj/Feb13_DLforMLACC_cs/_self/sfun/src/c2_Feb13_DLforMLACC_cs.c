...
static void initialize_c2_Feb13_DLforMLACC_cs
  (SFc2_Feb13_DLforMLACC_csInstanceStruct *chartInstance);
static void initialize_params_c2_Feb13_DLforMLACC_cs
  (SFc2_Feb13_DLforMLACC_csInstanceStruct *chartInstance);
static void enable_c2_Feb13_DLforMLACC_cs(SFc2_Feb13_DLforMLACC_csInstanceStruct
  *chartInstance);
static void disable_c2_Feb13_DLforMLACC_cs
  (SFc2_Feb13_DLforMLACC_csInstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_Feb13_DLforMLACC_cs
  (SFc2_Feb13_DLforMLACC_csInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_Feb13_DLforMLACC_cs
  (SFc2_Feb13_DLforMLACC_csInstanceStruct *chartInstance);
static void set_sim_state_c2_Feb13_DLforMLACC_cs
  (SFc2_Feb13_DLforMLACC_csInstanceStruct *chartInstance, const mxArray *c2_st);
static void finalize_c2_Feb13_DLforMLACC_cs
  (SFc2_Feb13_DLforMLACC_csInstanceStruct *chartInstance);
static void sf_gateway_c2_Feb13_DLforMLACC_cs
  (SFc2_Feb13_DLforMLACC_csInstanceStruct *chartInstance);
static void mdl_start_c2_Feb13_DLforMLACC_cs
  (SFc2_Feb13_DLforMLACC_csInstanceStruct *chartInstance);
static void initSimStructsc2_Feb13_DLforMLACC_cs
  (SFc2_Feb13_DLforMLACC_csInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber, uint32_T c2_instanceNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static real_T c2_emlrt_marshallIn(SFc2_Feb13_DLforMLACC_csInstanceStruct
...
static const mxArray *c2_emlrt_marshallOut
  (SFc2_Feb13_DLforMLACC_csInstanceStruct *chartInstance, const
...
static c2_PRESCAN_V2X_USER_GENERIC_MESSAGE c2_b_emlrt_marshallIn
  (SFc2_Feb13_DLforMLACC_csInstanceStruct *chartInstance, const mxArray *c2_b_y,
   const char_T *c2_identifier);
static c2_PRESCAN_V2X_USER_GENERIC_MESSAGE c2_c_emlrt_marshallIn
  (SFc2_Feb13_DLforMLACC_csInstanceStruct *chartInstance, const mxArray *c2_b_u,
   const emlrtMsgIdentifier *c2_parentId);
static PRESCAN_HEADER c2_d_emlrt_marshallIn
  (SFc2_Feb13_DLforMLACC_csInstanceStruct *chartInstance, const mxArray *c2_b_u,
   const emlrtMsgIdentifier *c2_parentId);
static boolean_T c2_e_emlrt_marshallIn(SFc2_Feb13_DLforMLACC_csInstanceStruct
  *chartInstance, const mxArray *c2_b_u, const emlrtMsgIdentifier *c2_parentId);
static c2_PRESCAN_V2X_USER_GENERIC_DATA c2_f_emlrt_marshallIn
  (SFc2_Feb13_DLforMLACC_csInstanceStruct *chartInstance, const mxArray *c2_b_u,
   const emlrtMsgIdentifier *c2_parentId);
static int32_T c2_g_emlrt_marshallIn(SFc2_Feb13_DLforMLACC_csInstanceStruct
  *chartInstance, const mxArray *c2_b_u, const emlrtMsgIdentifier *c2_parentId);
...
static const mxArray *c2_f_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_h_emlrt_marshallIn(SFc2_Feb13_DLforMLACC_csInstanceStruct
  *chartInstance, const mxArray *c2_b_u, const emlrtMsgIdentifier *c2_parentId,
  PRESCAN_V2X_FIXED_GENERIC_DATA *c2_b_y);
static void c2_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static void c2_i_emlrt_marshallIn(SFc2_Feb13_DLforMLACC_csInstanceStruct
  *chartInstance, const mxArray *c2_b_u, const emlrtMsgIdentifier *c2_parentId,
...
static uint8_T c2_j_emlrt_marshallIn(SFc2_Feb13_DLforMLACC_csInstanceStruct
  *chartInstance, const mxArray *c2_b_is_active_c2_Feb13_DLforMLACC_cs, const
  char_T *c2_identifier);
static uint8_T c2_k_emlrt_marshallIn(SFc2_Feb13_DLforMLACC_csInstanceStruct
  *chartInstance, const mxArray *c2_b_u, const emlrtMsgIdentifier *c2_parentId);
static void init_dsm_address_info(SFc2_Feb13_DLforMLACC_csInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc2_Feb13_DLforMLACC_csInstanceStruct
  *chartInstance);
  ...
  (SFc2_Feb13_DLforMLACC_csInstanceStruct *chartInstance)
{
  if (sf_is_first_init_cond(chartInstance->S)) {
    initSimStructsc2_Feb13_DLforMLACC_cs(chartInstance);
  ...
  chartInstance->c2_is_active_c2_Feb13_DLforMLACC_cs = 0U;
  ...
  (SFc2_Feb13_DLforMLACC_csInstanceStruct *chartInstance)
{
  ...
  c2_hoistedGlobal = chartInstance->c2_is_active_c2_Feb13_DLforMLACC_cs;
  c2_f_y = NULL;
  ...
  (SFc2_Feb13_DLforMLACC_csInstanceStruct *chartInstance, const mxArray *c2_st)
{
  ...
  *(int32_T *)&((char_T *)(c2_PRESCAN_V2X_USER_GENERIC_DATA *)&((char_T *)
  ...
  chartInstance->c2_is_active_c2_Feb13_DLforMLACC_cs = c2_j_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c2_b_u, 1)),
     "is_active_c2_Feb13_DLforMLACC_cs");
  sf_mex_destroy(&c2_b_u);
  c2_update_debugger_state_c2_Feb13_DLforMLACC_cs(chartInstance);
  ...
  c2_chartNumber, uint32_T c2_instanceNumber)
{
  ...
  _SFD_SCRIPT_TRANSLATION(c2_chartNumber, c2_instanceNumber, 0U,
    ...
    "C:\\Users\\s2lohras\\PreScan_Experiments\\Feb13_DLforMLACC\\V2X_GENERIC_filter.m"));
}
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_b_y = NULL;
  SFc2_Feb13_DLforMLACC_csInstanceStruct *chartInstance;
  chartInstance = (SFc2_Feb13_DLforMLACC_csInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c2_Feb13_DLforMLACC_cs_get_eml_resolved_functions_info(void)
{
  const mxArray *c2_nameCaptureInfo = NULL;
  const char * c2_data[4] = {
    "789cc553d14ec230142d8a441f34c407137fc229461f7c12eb9c182044d0981833c7b8648b6b4bdace20dfe247f813c64ff0771c8c41a959fa40c4fb727772ba"
    "7b6ecfbd45855aa38010da41697c94d2bc3dc5e5695e438ba1f3859c9cc5062aa275e5bf8c7f9f669f510943998228a4d08c49177802a8476056a6c748483d2a",
    "3b6f03401c048b5ea13761fa61049d90409d29e03a4c00b952a8191853e36f1c80ffd28e09e28198b71ba90029fe3ce7dcbf68f0470fdd1ffd9c49af64d033cd"
    "630b6daaeae799de30a79ee97e59fddd1cbdb2c6df571e5cc76edab735ec26d3929351a3e57dce744b1a9ef7913242f2d897cade2fa9d7ccd55be41fed277c66",
    "dd09e0c212958805dc13568b43dbf7a86b0f07c093dda4525857d03d3a762feb7dc61bf52ac6d66fc70ec84af7e4eb73ffbbbadabd5cf53bf83fbd65dfdd5e8e"
    "5e59e3f1e83464b673e888f80402a77f2346985dccfb6819744c7da01cfcd7f57f00597c6355",
    "" };
  ...
  char_T *c2_identifier)
{
  ...
  c2_b_y = c2_k_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_Feb13_DLforMLACC_cs), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_Feb13_DLforMLACC_cs);
  return c2_b_y;
}
...
/* SFunction Glue Code */
void sf_c2_Feb13_DLforMLACC_cs_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c2_Feb13_DLforMLACC_cs_get_post_codegen_info(void);
mxArray *sf_c2_Feb13_DLforMLACC_cs_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c2_Feb13_DLforMLACC_cs_get_post_codegen_info
      ();
...
mxArray *sf_c2_Feb13_DLforMLACC_cs_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c2_Feb13_DLforMLACC_cs_jit_fallback_info(void)
{
...
mxArray *sf_c2_Feb13_DLforMLACC_cs_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c2_Feb13_DLforMLACC_cs(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c2_Feb13_DLforMLACC_cs\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_Feb13_DLforMLACC_cs_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc2_Feb13_DLforMLACC_csInstanceStruct *chartInstance =
      (SFc2_Feb13_DLforMLACC_csInstanceStruct *)sf_get_chart_instance_ptr(S);
...
static void sf_opaque_initialize_c2_Feb13_DLforMLACC_cs(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_Feb13_DLforMLACC_csInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c2_Feb13_DLforMLACC_cs
    ((SFc2_Feb13_DLforMLACC_csInstanceStruct*) chartInstanceVar);
  initialize_c2_Feb13_DLforMLACC_cs((SFc2_Feb13_DLforMLACC_csInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c2_Feb13_DLforMLACC_cs(void *chartInstanceVar)
{
  enable_c2_Feb13_DLforMLACC_cs((SFc2_Feb13_DLforMLACC_csInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c2_Feb13_DLforMLACC_cs(void *chartInstanceVar)
{
  disable_c2_Feb13_DLforMLACC_cs((SFc2_Feb13_DLforMLACC_csInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c2_Feb13_DLforMLACC_cs(void *chartInstanceVar)
{
  sf_gateway_c2_Feb13_DLforMLACC_cs((SFc2_Feb13_DLforMLACC_csInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c2_Feb13_DLforMLACC_cs(SimStruct*
  S)
{
  return get_sim_state_c2_Feb13_DLforMLACC_cs
    ((SFc2_Feb13_DLforMLACC_csInstanceStruct *)sf_get_chart_instance_ptr(S));/* raw sim ctx */
}

static void sf_opaque_set_sim_state_c2_Feb13_DLforMLACC_cs(SimStruct* S, const
  mxArray *st)
{
  set_sim_state_c2_Feb13_DLforMLACC_cs((SFc2_Feb13_DLforMLACC_csInstanceStruct*)
    sf_get_chart_instance_ptr(S), st);
}

static void sf_opaque_terminate_c2_Feb13_DLforMLACC_cs(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_Feb13_DLforMLACC_csInstanceStruct*) chartInstanceVar
      )->S;
    ...
    finalize_c2_Feb13_DLforMLACC_cs((SFc2_Feb13_DLforMLACC_csInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc2_Feb13_DLforMLACC_cs((SFc2_Feb13_DLforMLACC_csInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_Feb13_DLforMLACC_cs(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_Feb13_DLforMLACC_cs(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(3645969544U));
  ssSetChecksum1(S,(2736150709U));
  ssSetChecksum2(S,(1165633664U));
  ssSetChecksum3(S,(1102335367U));
...
static void mdlRTW_c2_Feb13_DLforMLACC_cs(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_Feb13_DLforMLACC_cs(SimStruct *S)
{
  SFc2_Feb13_DLforMLACC_csInstanceStruct *chartInstance;
  chartInstance = (SFc2_Feb13_DLforMLACC_csInstanceStruct *)utMalloc(sizeof
    (SFc2_Feb13_DLforMLACC_csInstanceStruct));
  if (chartInstance==NULL) {
    sf_mex_error_message("Could not allocate memory for chart instance.");
  }

  memset(chartInstance, 0, sizeof(SFc2_Feb13_DLforMLACC_csInstanceStruct));
  chartInstance->chartInfo.chartInstance = chartInstance;
  chartInstance->chartInfo.isEMLChart = 1;
  chartInstance->chartInfo.chartInitialized = 0;
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_Feb13_DLforMLACC_cs;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_Feb13_DLforMLACC_cs;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_Feb13_DLforMLACC_cs;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c2_Feb13_DLforMLACC_cs;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c2_Feb13_DLforMLACC_cs;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_Feb13_DLforMLACC_cs;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_Feb13_DLforMLACC_cs;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_Feb13_DLforMLACC_cs;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_Feb13_DLforMLACC_cs;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_Feb13_DLforMLACC_cs;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_Feb13_DLforMLACC_cs;
  ...
  mdl_start_c2_Feb13_DLforMLACC_cs(chartInstance);
}

void c2_Feb13_DLforMLACC_cs_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_Feb13_DLforMLACC_cs(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_Feb13_DLforMLACC_cs(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_Feb13_DLforMLACC_cs(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_Feb13_DLforMLACC_cs_method_dispatcher.\n"
