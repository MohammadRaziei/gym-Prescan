...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  extern unsigned int sf_Feb13_DLforMLACC_cs_process_check_sum_call( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_Feb13_DLforMLACC_cs_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int sf_Feb13_DLforMLACC_cs_autoinheritance_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  ...
  if (strcmp(machineName, "Feb13_DLforMLACC_cs") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_Feb13_DLforMLACC_cs_autoinheritance_info(nlhs,plhs,3,newRhs);
  }
...
{
  extern unsigned int sf_Feb13_DLforMLACC_cs_third_party_uses_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 4) {
  ...
  if (strcmp(machineName, "Feb13_DLforMLACC_cs") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_Feb13_DLforMLACC_cs_third_party_uses_info(nlhs,plhs,3,newRhs);
  }
...
{
  extern unsigned int sf_Feb13_DLforMLACC_cs_jit_fallback_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 4) {
  ...
  if (strcmp(machineName, "Feb13_DLforMLACC_cs") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_Feb13_DLforMLACC_cs_jit_fallback_info(nlhs,plhs,3,newRhs);
  }
...
unsigned int sf_process_get_updateBuildInfo_args_info_call( int nlhs, mxArray *
  plhs[], int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_Feb13_DLforMLACC_cs_updateBuildInfo_args_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 4) {
  ...
  if (strcmp(machineName, "Feb13_DLforMLACC_cs") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_Feb13_DLforMLACC_cs_updateBuildInfo_args_info(nlhs,plhs,3,newRhs);
  }
...
unsigned int sf_process_get_eml_resolved_functions_info_call( int nlhs, mxArray *
  plhs[], int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_Feb13_DLforMLACC_cs_get_eml_resolved_functions_info
  ...
  if (strcmp(machineName, "Feb13_DLforMLACC_cs") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_Feb13_DLforMLACC_cs_get_eml_resolved_functions_info(nlhs,plhs,3,
      newRhs);
  }
...
extern unsigned int sf_Feb13_DLforMLACC_cs_method_dispatcher(SimStruct *S,
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"Feb13_DLforMLACC_cs")) {
    return(sf_Feb13_DLforMLACC_cs_method_dispatcher(simstructPtr,chartFileNumber,
...
extern void Feb13_DLforMLACC_cs_terminator(void);
void sf_machine_global_terminator(SimStruct* S)
{
  (void)S;
  sfGlobalMdlStartCallCounts--;
  if (sfGlobalMdlStartCallCounts == 0) {
    Feb13_DLforMLACC_cs_terminator();
    slcovUploadCoverageSynthesisById("Feb13_DLforMLACC_cs@Feb13_DLforMLACC_cs");
...
extern void Feb13_DLforMLACC_cs_initializer(void);
extern void Feb13_DLforMLACC_cs_register_exported_symbols(SimStruct* S);
extern void Feb13_DLforMLACC_cs_debug_initialize(struct SfDebugInstanceStruct*);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  Feb13_DLforMLACC_cs_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfGlobalMdlStartCallCounts == 1) {
    ...
    if (!simModeIsRTWGen) {
      Feb13_DLforMLACC_cs_debug_initialize(sfGlobalDebugInstanceStruct);
    }

    Feb13_DLforMLACC_cs_initializer();
    slcovUploadCoverageSynthesisById("Feb13_DLforMLACC_cs@Feb13_DLforMLACC_cs");
  }
