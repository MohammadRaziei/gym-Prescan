...
static void initialize_c8_Feb13_DLforMLACC_cs
  (SFc8_Feb13_DLforMLACC_csInstanceStruct *chartInstance);
static void initialize_params_c8_Feb13_DLforMLACC_cs
  (SFc8_Feb13_DLforMLACC_csInstanceStruct *chartInstance);
static void enable_c8_Feb13_DLforMLACC_cs(SFc8_Feb13_DLforMLACC_csInstanceStruct
  *chartInstance);
static void disable_c8_Feb13_DLforMLACC_cs
  (SFc8_Feb13_DLforMLACC_csInstanceStruct *chartInstance);
static void c8_update_debugger_state_c8_Feb13_DLforMLACC_cs
  (SFc8_Feb13_DLforMLACC_csInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c8_Feb13_DLforMLACC_cs
  (SFc8_Feb13_DLforMLACC_csInstanceStruct *chartInstance);
static void set_sim_state_c8_Feb13_DLforMLACC_cs
  (SFc8_Feb13_DLforMLACC_csInstanceStruct *chartInstance, const mxArray *c8_st);
static void finalize_c8_Feb13_DLforMLACC_cs
  (SFc8_Feb13_DLforMLACC_csInstanceStruct *chartInstance);
static void sf_gateway_c8_Feb13_DLforMLACC_cs
  (SFc8_Feb13_DLforMLACC_csInstanceStruct *chartInstance);
static void mdl_start_c8_Feb13_DLforMLACC_cs
  (SFc8_Feb13_DLforMLACC_csInstanceStruct *chartInstance);
static void initSimStructsc8_Feb13_DLforMLACC_cs
  (SFc8_Feb13_DLforMLACC_csInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c8_machineNumber, uint32_T
  c8_chartNumber, uint32_T c8_instanceNumber);
static const mxArray *c8_sf_marshallOut(void *chartInstanceVoid, void *c8_inData);
static real_T c8_emlrt_marshallIn(SFc8_Feb13_DLforMLACC_csInstanceStruct
...
static const mxArray *c8_emlrt_marshallOut
  (SFc8_Feb13_DLforMLACC_csInstanceStruct *chartInstance, const
...
static const mxArray *c8_c_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static void c8_b_emlrt_marshallIn(SFc8_Feb13_DLforMLACC_csInstanceStruct
  *chartInstance, const mxArray *c8_b_y, const char_T *c8_identifier,
  PRESCAN_V2X_FIXED_GENERIC_MESSAGE *c8_c_y);
static void c8_c_emlrt_marshallIn(SFc8_Feb13_DLforMLACC_csInstanceStruct
  *chartInstance, const mxArray *c8_b_u, const emlrtMsgIdentifier *c8_parentId,
  PRESCAN_V2X_FIXED_GENERIC_MESSAGE *c8_b_y);
static PRESCAN_HEADER c8_d_emlrt_marshallIn
  (SFc8_Feb13_DLforMLACC_csInstanceStruct *chartInstance, const mxArray *c8_b_u,
   const emlrtMsgIdentifier *c8_parentId);
static boolean_T c8_e_emlrt_marshallIn(SFc8_Feb13_DLforMLACC_csInstanceStruct
  *chartInstance, const mxArray *c8_b_u, const emlrtMsgIdentifier *c8_parentId);
static void c8_f_emlrt_marshallIn(SFc8_Feb13_DLforMLACC_csInstanceStruct
  *chartInstance, const mxArray *c8_b_u, const emlrtMsgIdentifier *c8_parentId,
  PRESCAN_V2X_FIXED_GENERIC_DATA *c8_b_y);
static int32_T c8_g_emlrt_marshallIn(SFc8_Feb13_DLforMLACC_csInstanceStruct
  *chartInstance, const mxArray *c8_b_u, const emlrtMsgIdentifier *c8_parentId);
...
static uint8_T c8_j_emlrt_marshallIn(SFc8_Feb13_DLforMLACC_csInstanceStruct
  *chartInstance, const mxArray *c8_b_is_active_c8_Feb13_DLforMLACC_cs, const
  char_T *c8_identifier);
static uint8_T c8_k_emlrt_marshallIn(SFc8_Feb13_DLforMLACC_csInstanceStruct
  *chartInstance, const mxArray *c8_b_u, const emlrtMsgIdentifier *c8_parentId);
static void init_dsm_address_info(SFc8_Feb13_DLforMLACC_csInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc8_Feb13_DLforMLACC_csInstanceStruct
  *chartInstance);
  ...
  (SFc8_Feb13_DLforMLACC_csInstanceStruct *chartInstance)
{
  if (sf_is_first_init_cond(chartInstance->S)) {
    initSimStructsc8_Feb13_DLforMLACC_cs(chartInstance);
  ...
  chartInstance->c8_is_active_c8_Feb13_DLforMLACC_cs = 0U;
  ...
  (SFc8_Feb13_DLforMLACC_csInstanceStruct *chartInstance)
{
  ...
  c8_hoistedGlobal = chartInstance->c8_is_active_c8_Feb13_DLforMLACC_cs;
  c8_f_y = NULL;
  ...
  (SFc8_Feb13_DLforMLACC_csInstanceStruct *chartInstance, const mxArray *c8_st)
{
  ...
  *(int32_T *)&((char_T *)(PRESCAN_V2X_FIXED_GENERIC_DATA *)&((char_T *)
  ...
  chartInstance->c8_is_active_c8_Feb13_DLforMLACC_cs = c8_j_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c8_b_u, 1)),
     "is_active_c8_Feb13_DLforMLACC_cs");
  sf_mex_destroy(&c8_b_u);
  c8_update_debugger_state_c8_Feb13_DLforMLACC_cs(chartInstance);
  ...
  c8_chartNumber, uint32_T c8_instanceNumber)
{
  ...
  _SFD_SCRIPT_TRANSLATION(c8_chartNumber, c8_instanceNumber, 0U,
    ...
    "C:\\Users\\s2lohras\\PreScan_Experiments\\Feb13_DLforMLACC\\V2X_GENERIC_expander.m"));
}
...
static const mxArray *c8_sf_marshallOut(void *chartInstanceVoid, void *c8_inData)
{
  ...
  const mxArray *c8_b_y = NULL;
  SFc8_Feb13_DLforMLACC_csInstanceStruct *chartInstance;
  chartInstance = (SFc8_Feb13_DLforMLACC_csInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c8_Feb13_DLforMLACC_cs_get_eml_resolved_functions_info(void)
{
  const mxArray *c8_nameCaptureInfo = NULL;
  const char * c8_data[4] = {
    "789cc593cf4ec24010c60745a2070d0763e24bd80007134f422d420424fc118331b594411abb5bb25bb4fa2c3e842f617c045f47a014968d9b1e883897e997af"
    "9ddfecec1412e56a02000e208c8f5498f7e73a3dcf5bb01ab29f50e428762009dbc27791ff3ecfb6477d0cfc50b80ec5da98f4904d04b5082ecaf43de2508bfa",
    "add7110243eeb9cfd89f3903c7c59643b0e209a2e44c04290ad6424cade9b33e44fba93926c0867cd9ae2b0a10e6f3a0387f32663e72c8f391df8be3a5627871"
    "f7b107bb22fd3ce2058a7a71e78bea1f2a7869c9bfc9de9a9746cd68947513839145fbb3cb5e7bce113725e9651fa1c37d36b67d61efd7e4d595bc55ffceb8d7",
    "cfb43647c6359e75bd21b3b85667d8b42d6a1ac108d96437a9cfb522f63239f3a232f058b592d775edb7899d900deec9d7e7f1777eb37bb9e9ffe0ff78ebfe77"
    "470a5e5af2bbdd52fdb4fdd2b279eeba90619dabb7c746a7b0ec23da531527ae0f50e8bfaeff0336ef64bd",
    "" };
  ...
  char_T *c8_identifier)
{
  ...
  c8_b_y = c8_k_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c8_b_is_active_c8_Feb13_DLforMLACC_cs), &c8_thisId);
  sf_mex_destroy(&c8_b_is_active_c8_Feb13_DLforMLACC_cs);
  return c8_b_y;
}
...
/* SFunction Glue Code */
void sf_c8_Feb13_DLforMLACC_cs_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c8_Feb13_DLforMLACC_cs_get_post_codegen_info(void);
mxArray *sf_c8_Feb13_DLforMLACC_cs_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c8_Feb13_DLforMLACC_cs_get_post_codegen_info
      ();
...
mxArray *sf_c8_Feb13_DLforMLACC_cs_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c8_Feb13_DLforMLACC_cs_jit_fallback_info(void)
{
...
mxArray *sf_c8_Feb13_DLforMLACC_cs_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c8_Feb13_DLforMLACC_cs(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c8_Feb13_DLforMLACC_cs\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c8_Feb13_DLforMLACC_cs_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc8_Feb13_DLforMLACC_csInstanceStruct *chartInstance =
      (SFc8_Feb13_DLforMLACC_csInstanceStruct *)sf_get_chart_instance_ptr(S);
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        init_script_number_translation(_Feb13_DLforMLACC_csMachineNumber_,
          chartInstance->chartNumber,chartInstance->instanceNumber);
        if (chartAlreadyPresent==0) {
          /* this is the first instance */
          sf_debug_set_chart_disable_implicit_casting
            (sfGlobalDebugInstanceStruct,_Feb13_DLforMLACC_csMachineNumber_,
      ...
      sf_debug_reset_current_state_configuration(sfGlobalDebugInstanceStruct,
        _Feb13_DLforMLACC_csMachineNumber_,chartInstance->chartNumber,
        chartInstance->instanceNumber);
    }
  }
}
...
static void sf_opaque_initialize_c8_Feb13_DLforMLACC_cs(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc8_Feb13_DLforMLACC_csInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c8_Feb13_DLforMLACC_cs
    ((SFc8_Feb13_DLforMLACC_csInstanceStruct*) chartInstanceVar);
  initialize_c8_Feb13_DLforMLACC_cs((SFc8_Feb13_DLforMLACC_csInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c8_Feb13_DLforMLACC_cs(void *chartInstanceVar)
{
  enable_c8_Feb13_DLforMLACC_cs((SFc8_Feb13_DLforMLACC_csInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c8_Feb13_DLforMLACC_cs(void *chartInstanceVar)
{
  disable_c8_Feb13_DLforMLACC_cs((SFc8_Feb13_DLforMLACC_csInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c8_Feb13_DLforMLACC_cs(void *chartInstanceVar)
{
  sf_gateway_c8_Feb13_DLforMLACC_cs((SFc8_Feb13_DLforMLACC_csInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c8_Feb13_DLforMLACC_cs(SimStruct*
  S)
{
  return get_sim_state_c8_Feb13_DLforMLACC_cs
    ((SFc8_Feb13_DLforMLACC_csInstanceStruct *)sf_get_chart_instance_ptr(S));/* raw sim ctx */
}

static void sf_opaque_set_sim_state_c8_Feb13_DLforMLACC_cs(SimStruct* S, const
  mxArray *st)
{
  set_sim_state_c8_Feb13_DLforMLACC_cs((SFc8_Feb13_DLforMLACC_csInstanceStruct*)
    sf_get_chart_instance_ptr(S), st);
}

static void sf_opaque_terminate_c8_Feb13_DLforMLACC_cs(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc8_Feb13_DLforMLACC_csInstanceStruct*) chartInstanceVar
      )->S;
    ...
    finalize_c8_Feb13_DLforMLACC_cs((SFc8_Feb13_DLforMLACC_csInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc8_Feb13_DLforMLACC_cs((SFc8_Feb13_DLforMLACC_csInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c8_Feb13_DLforMLACC_cs(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c8_Feb13_DLforMLACC_cs(SimStruct *S)
{
  ...
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_Feb13_DLforMLACC_cs_optimization_info
  ...
  ssSetChecksum0(S,(2019919938U));
  ssSetChecksum1(S,(171536308U));
  ssSetChecksum2(S,(2817876646U));
  ssSetChecksum3(S,(3955365421U));
...
static void mdlRTW_c8_Feb13_DLforMLACC_cs(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c8_Feb13_DLforMLACC_cs(SimStruct *S)
{
  SFc8_Feb13_DLforMLACC_csInstanceStruct *chartInstance;
  chartInstance = (SFc8_Feb13_DLforMLACC_csInstanceStruct *)utMalloc(sizeof
    (SFc8_Feb13_DLforMLACC_csInstanceStruct));
  if (chartInstance==NULL) {
    sf_mex_error_message("Could not allocate memory for chart instance.");
  }

  memset(chartInstance, 0, sizeof(SFc8_Feb13_DLforMLACC_csInstanceStruct));
  chartInstance->chartInfo.chartInstance = chartInstance;
  chartInstance->chartInfo.isEMLChart = 1;
  chartInstance->chartInfo.chartInitialized = 0;
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c8_Feb13_DLforMLACC_cs;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c8_Feb13_DLforMLACC_cs;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c8_Feb13_DLforMLACC_cs;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c8_Feb13_DLforMLACC_cs;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c8_Feb13_DLforMLACC_cs;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c8_Feb13_DLforMLACC_cs;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c8_Feb13_DLforMLACC_cs;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c8_Feb13_DLforMLACC_cs;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c8_Feb13_DLforMLACC_cs;
  chartInstance->chartInfo.mdlStart = mdlStart_c8_Feb13_DLforMLACC_cs;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c8_Feb13_DLforMLACC_cs;
  ...
  mdl_start_c8_Feb13_DLforMLACC_cs(chartInstance);
}

void c8_Feb13_DLforMLACC_cs_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c8_Feb13_DLforMLACC_cs(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c8_Feb13_DLforMLACC_cs(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c8_Feb13_DLforMLACC_cs(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c8_Feb13_DLforMLACC_cs_method_dispatcher.\n"
