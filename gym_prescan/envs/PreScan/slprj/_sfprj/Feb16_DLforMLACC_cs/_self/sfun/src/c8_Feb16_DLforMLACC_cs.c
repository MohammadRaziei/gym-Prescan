...
#include "Feb16_DLforMLACC_cs_sfun.h"
#include "c8_Feb16_DLforMLACC_cs.h"
#define CHARTINSTANCE_CHARTNUMBER      (chartInstance->chartNumber)
#define CHARTINSTANCE_INSTANCENUMBER   (chartInstance->instanceNumber)
#include "Feb16_DLforMLACC_cs_sfun_debug_macros.h"
...
static const char * c8_sv1[22] = { "messageID", "senderID", "signal_1",
  "signal_2", "signal_3", "signal_4", "signal_5", "signal_6", "signal_7",
  "signal_8", "signal_9", "signal_10", "discrete_signal_1", "discrete_signal_2",
  "discrete_signal_3", "discrete_signal_4", "discrete_signal_5",
  "discrete_signal_6", "discrete_signal_7", "discrete_signal_8",
  "discrete_signal_9", "discrete_signal_10" };

static const char * c8_sv2[6] = { "messageID", "senderID", "signal_1",
  "signal_4", "signal_5", "discrete_signal_3" };

static const char * c8_sv3[2] = { "HEADER", "DATA" };

/* Function Declarations */
static void initialize_c8_Feb16_DLforMLACC_cs
  (SFc8_Feb16_DLforMLACC_csInstanceStruct *chartInstance);
static void initialize_params_c8_Feb16_DLforMLACC_cs
  (SFc8_Feb16_DLforMLACC_csInstanceStruct *chartInstance);
static void enable_c8_Feb16_DLforMLACC_cs(SFc8_Feb16_DLforMLACC_csInstanceStruct
  *chartInstance);
static void disable_c8_Feb16_DLforMLACC_cs
  (SFc8_Feb16_DLforMLACC_csInstanceStruct *chartInstance);
static void c8_update_debugger_state_c8_Feb16_DLforMLACC_cs
  (SFc8_Feb16_DLforMLACC_csInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c8_Feb16_DLforMLACC_cs
  (SFc8_Feb16_DLforMLACC_csInstanceStruct *chartInstance);
static void set_sim_state_c8_Feb16_DLforMLACC_cs
  (SFc8_Feb16_DLforMLACC_csInstanceStruct *chartInstance, const mxArray *c8_st);
static void finalize_c8_Feb16_DLforMLACC_cs
  (SFc8_Feb16_DLforMLACC_csInstanceStruct *chartInstance);
static void sf_gateway_c8_Feb16_DLforMLACC_cs
  (SFc8_Feb16_DLforMLACC_csInstanceStruct *chartInstance);
static void mdl_start_c8_Feb16_DLforMLACC_cs
  (SFc8_Feb16_DLforMLACC_csInstanceStruct *chartInstance);
static void initSimStructsc8_Feb16_DLforMLACC_cs
  (SFc8_Feb16_DLforMLACC_csInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c8_machineNumber, uint32_T
  c8_chartNumber, uint32_T c8_instanceNumber);
static const mxArray *c8_sf_marshallOut(void *chartInstanceVoid, void *c8_inData);
static real_T c8_emlrt_marshallIn(SFc8_Feb16_DLforMLACC_csInstanceStruct
...
static const mxArray *c8_c_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static void c8_b_emlrt_marshallIn(SFc8_Feb16_DLforMLACC_csInstanceStruct
  *chartInstance, const mxArray *c8_b_y, const char_T *c8_identifier,
  PRESCAN_V2X_FIXED_GENERIC_MESSAGE *c8_c_y);
static void c8_c_emlrt_marshallIn(SFc8_Feb16_DLforMLACC_csInstanceStruct
  *chartInstance, const mxArray *c8_b_u, const emlrtMsgIdentifier *c8_parentId,
  PRESCAN_V2X_FIXED_GENERIC_MESSAGE *c8_b_y);
static PRESCAN_HEADER c8_d_emlrt_marshallIn
  (SFc8_Feb16_DLforMLACC_csInstanceStruct *chartInstance, const mxArray *c8_b_u,
   const emlrtMsgIdentifier *c8_parentId);
static boolean_T c8_e_emlrt_marshallIn(SFc8_Feb16_DLforMLACC_csInstanceStruct
  *chartInstance, const mxArray *c8_b_u, const emlrtMsgIdentifier *c8_parentId);
static void c8_f_emlrt_marshallIn(SFc8_Feb16_DLforMLACC_csInstanceStruct
  *chartInstance, const mxArray *c8_b_u, const emlrtMsgIdentifier *c8_parentId,
  PRESCAN_V2X_FIXED_GENERIC_DATA *c8_b_y);
static int32_T c8_g_emlrt_marshallIn(SFc8_Feb16_DLforMLACC_csInstanceStruct
  *chartInstance, const mxArray *c8_b_u, const emlrtMsgIdentifier *c8_parentId);
...
static uint8_T c8_j_emlrt_marshallIn(SFc8_Feb16_DLforMLACC_csInstanceStruct
  *chartInstance, const mxArray *c8_b_is_active_c8_Feb16_DLforMLACC_cs, const
  char_T *c8_identifier);
static uint8_T c8_k_emlrt_marshallIn(SFc8_Feb16_DLforMLACC_csInstanceStruct
  *chartInstance, const mxArray *c8_b_u, const emlrtMsgIdentifier *c8_parentId);
static void init_dsm_address_info(SFc8_Feb16_DLforMLACC_csInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc8_Feb16_DLforMLACC_csInstanceStruct
  *chartInstance);
  ...
  (SFc8_Feb16_DLforMLACC_csInstanceStruct *chartInstance)
{
  if (sf_is_first_init_cond(chartInstance->S)) {
    initSimStructsc8_Feb16_DLforMLACC_cs(chartInstance);
  ...
  chartInstance->c8_is_active_c8_Feb16_DLforMLACC_cs = 0U;
  ...
  (SFc8_Feb16_DLforMLACC_csInstanceStruct *chartInstance)
{
  ...
  PRESCAN_V2X_FIXED_GENERIC_DATA c8_d_u;
  ...
  c8_d_y = NULL;
  sf_mex_assign(&c8_d_y, sf_mex_createstruct("structure", 1, c8_sv4, 2, 1, 1),
                false);
  c8_c_u = c8_b_u.valid;
  c8_e_y = NULL;
  ...
  c8_d_u.messageID = *(int32_T *)&((char_T *)(PRESCAN_V2X_FIXED_GENERIC_DATA *)
    &((char_T *)chartInstance->c8_y)[8])[0];
  c8_d_u.senderID = *(int32_T *)&((char_T *)(PRESCAN_V2X_FIXED_GENERIC_DATA *)
    &((char_T *)chartInstance->c8_y)[8])[4];
  c8_d_u.signal_1 = *(real_T *)&((char_T *)(PRESCAN_V2X_FIXED_GENERIC_DATA *)
    &((char_T *)chartInstance->c8_y)[8])[8];
  c8_d_u.signal_2 = *(real_T *)&((char_T *)(PRESCAN_V2X_FIXED_GENERIC_DATA *)
    &((char_T *)chartInstance->c8_y)[8])[16];
  c8_d_u.signal_3 = *(real_T *)&((char_T *)(PRESCAN_V2X_FIXED_GENERIC_DATA *)
    &((char_T *)chartInstance->c8_y)[8])[24];
  c8_d_u.signal_4 = *(real_T *)&((char_T *)(PRESCAN_V2X_FIXED_GENERIC_DATA *)
    &((char_T *)chartInstance->c8_y)[8])[32];
  c8_d_u.signal_5 = *(real_T *)&((char_T *)(PRESCAN_V2X_FIXED_GENERIC_DATA *)
    &((char_T *)chartInstance->c8_y)[8])[40];
  c8_d_u.signal_6 = *(real_T *)&((char_T *)(PRESCAN_V2X_FIXED_GENERIC_DATA *)
    &((char_T *)chartInstance->c8_y)[8])[48];
  c8_d_u.signal_7 = *(real_T *)&((char_T *)(PRESCAN_V2X_FIXED_GENERIC_DATA *)
    &((char_T *)chartInstance->c8_y)[8])[56];
  c8_d_u.signal_8 = *(real_T *)&((char_T *)(PRESCAN_V2X_FIXED_GENERIC_DATA *)
    &((char_T *)chartInstance->c8_y)[8])[64];
  c8_d_u.signal_9 = *(real_T *)&((char_T *)(PRESCAN_V2X_FIXED_GENERIC_DATA *)
    &((char_T *)chartInstance->c8_y)[8])[72];
  c8_d_u.signal_10 = *(real_T *)&((char_T *)(PRESCAN_V2X_FIXED_GENERIC_DATA *)
    &((char_T *)chartInstance->c8_y)[8])[80];
  c8_d_u.discrete_signal_1 = *(int32_T *)&((char_T *)
    (PRESCAN_V2X_FIXED_GENERIC_DATA *)&((char_T *)chartInstance->c8_y)[8])[88];
  c8_d_u.discrete_signal_2 = *(int32_T *)&((char_T *)
    (PRESCAN_V2X_FIXED_GENERIC_DATA *)&((char_T *)chartInstance->c8_y)[8])[92];
  c8_d_u.discrete_signal_3 = *(int32_T *)&((char_T *)
    (PRESCAN_V2X_FIXED_GENERIC_DATA *)&((char_T *)chartInstance->c8_y)[8])[96];
  c8_d_u.discrete_signal_4 = *(int32_T *)&((char_T *)
    (PRESCAN_V2X_FIXED_GENERIC_DATA *)&((char_T *)chartInstance->c8_y)[8])[100];
  c8_d_u.discrete_signal_5 = *(int32_T *)&((char_T *)
    (PRESCAN_V2X_FIXED_GENERIC_DATA *)&((char_T *)chartInstance->c8_y)[8])[104];
  c8_d_u.discrete_signal_6 = *(int32_T *)&((char_T *)
    (PRESCAN_V2X_FIXED_GENERIC_DATA *)&((char_T *)chartInstance->c8_y)[8])[108];
  c8_d_u.discrete_signal_7 = *(int32_T *)&((char_T *)
    (PRESCAN_V2X_FIXED_GENERIC_DATA *)&((char_T *)chartInstance->c8_y)[8])[112];
  c8_d_u.discrete_signal_8 = *(int32_T *)&((char_T *)
    (PRESCAN_V2X_FIXED_GENERIC_DATA *)&((char_T *)chartInstance->c8_y)[8])[116];
  c8_d_u.discrete_signal_9 = *(int32_T *)&((char_T *)
    (PRESCAN_V2X_FIXED_GENERIC_DATA *)&((char_T *)chartInstance->c8_y)[8])[120];
  c8_d_u.discrete_signal_10 = *(int32_T *)&((char_T *)
    (PRESCAN_V2X_FIXED_GENERIC_DATA *)&((char_T *)chartInstance->c8_y)[8])[124];
  c8_f_y = NULL;
  sf_mex_assign(&c8_f_y, sf_mex_createstruct("structure", 22, c8_sv1, 2, 1, 1),
                false);
  c8_e_u = c8_d_u.messageID;
  c8_g_y = NULL;
  sf_mex_assign(&c8_g_y, sf_mex_create("y", &c8_e_u, 6, 0U, 0U, 0U, 0), false);
  sf_mex_setfieldbynum(c8_f_y, 0, "messageID", c8_g_y, 0);
  c8_f_u = c8_d_u.senderID;
  c8_h_y = NULL;
  sf_mex_assign(&c8_h_y, sf_mex_create("y", &c8_f_u, 6, 0U, 0U, 0U, 0), false);
  sf_mex_setfieldbynum(c8_f_y, 0, "senderID", c8_h_y, 1);
  c8_g_u = c8_d_u.signal_1;
  c8_i_y = NULL;
  sf_mex_assign(&c8_i_y, sf_mex_create("y", &c8_g_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setfieldbynum(c8_f_y, 0, "signal_1", c8_i_y, 2);
  c8_h_u = c8_d_u.signal_2;
  c8_j_y = NULL;
  sf_mex_assign(&c8_j_y, sf_mex_create("y", &c8_h_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setfieldbynum(c8_f_y, 0, "signal_2", c8_j_y, 3);
  c8_i_u = c8_d_u.signal_3;
  c8_k_y = NULL;
  sf_mex_assign(&c8_k_y, sf_mex_create("y", &c8_i_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setfieldbynum(c8_f_y, 0, "signal_3", c8_k_y, 4);
  c8_j_u = c8_d_u.signal_4;
  c8_l_y = NULL;
  sf_mex_assign(&c8_l_y, sf_mex_create("y", &c8_j_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setfieldbynum(c8_f_y, 0, "signal_4", c8_l_y, 5);
  c8_k_u = c8_d_u.signal_5;
  c8_m_y = NULL;
  sf_mex_assign(&c8_m_y, sf_mex_create("y", &c8_k_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setfieldbynum(c8_f_y, 0, "signal_5", c8_m_y, 6);
  c8_l_u = c8_d_u.signal_6;
  c8_n_y = NULL;
  sf_mex_assign(&c8_n_y, sf_mex_create("y", &c8_l_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setfieldbynum(c8_f_y, 0, "signal_6", c8_n_y, 7);
  c8_m_u = c8_d_u.signal_7;
  c8_o_y = NULL;
  sf_mex_assign(&c8_o_y, sf_mex_create("y", &c8_m_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setfieldbynum(c8_f_y, 0, "signal_7", c8_o_y, 8);
  c8_n_u = c8_d_u.signal_8;
  c8_p_y = NULL;
  sf_mex_assign(&c8_p_y, sf_mex_create("y", &c8_n_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setfieldbynum(c8_f_y, 0, "signal_8", c8_p_y, 9);
  c8_o_u = c8_d_u.signal_9;
  c8_q_y = NULL;
  sf_mex_assign(&c8_q_y, sf_mex_create("y", &c8_o_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setfieldbynum(c8_f_y, 0, "signal_9", c8_q_y, 10);
  c8_p_u = c8_d_u.signal_10;
  c8_r_y = NULL;
  sf_mex_assign(&c8_r_y, sf_mex_create("y", &c8_p_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setfieldbynum(c8_f_y, 0, "signal_10", c8_r_y, 11);
  c8_q_u = c8_d_u.discrete_signal_1;
  c8_s_y = NULL;
  sf_mex_assign(&c8_s_y, sf_mex_create("y", &c8_q_u, 6, 0U, 0U, 0U, 0), false);
  sf_mex_setfieldbynum(c8_f_y, 0, "discrete_signal_1", c8_s_y, 12);
  c8_r_u = c8_d_u.discrete_signal_2;
  c8_t_y = NULL;
  sf_mex_assign(&c8_t_y, sf_mex_create("y", &c8_r_u, 6, 0U, 0U, 0U, 0), false);
  sf_mex_setfieldbynum(c8_f_y, 0, "discrete_signal_2", c8_t_y, 13);
  c8_s_u = c8_d_u.discrete_signal_3;
  c8_u_y = NULL;
  sf_mex_assign(&c8_u_y, sf_mex_create("y", &c8_s_u, 6, 0U, 0U, 0U, 0), false);
  sf_mex_setfieldbynum(c8_f_y, 0, "discrete_signal_3", c8_u_y, 14);
  c8_t_u = c8_d_u.discrete_signal_4;
  c8_v_y = NULL;
  sf_mex_assign(&c8_v_y, sf_mex_create("y", &c8_t_u, 6, 0U, 0U, 0U, 0), false);
  sf_mex_setfieldbynum(c8_f_y, 0, "discrete_signal_4", c8_v_y, 15);
  c8_u_u = c8_d_u.discrete_signal_5;
  c8_w_y = NULL;
  sf_mex_assign(&c8_w_y, sf_mex_create("y", &c8_u_u, 6, 0U, 0U, 0U, 0), false);
  sf_mex_setfieldbynum(c8_f_y, 0, "discrete_signal_5", c8_w_y, 16);
  c8_v_u = c8_d_u.discrete_signal_6;
  c8_x_y = NULL;
  sf_mex_assign(&c8_x_y, sf_mex_create("y", &c8_v_u, 6, 0U, 0U, 0U, 0), false);
  sf_mex_setfieldbynum(c8_f_y, 0, "discrete_signal_6", c8_x_y, 17);
  c8_w_u = c8_d_u.discrete_signal_7;
  c8_y_y = NULL;
  sf_mex_assign(&c8_y_y, sf_mex_create("y", &c8_w_u, 6, 0U, 0U, 0U, 0), false);
  sf_mex_setfieldbynum(c8_f_y, 0, "discrete_signal_7", c8_y_y, 18);
  c8_x_u = c8_d_u.discrete_signal_8;
  c8_ab_y = NULL;
  sf_mex_assign(&c8_ab_y, sf_mex_create("y", &c8_x_u, 6, 0U, 0U, 0U, 0), false);
  sf_mex_setfieldbynum(c8_f_y, 0, "discrete_signal_8", c8_ab_y, 19);
  c8_y_u = c8_d_u.discrete_signal_9;
  c8_bb_y = NULL;
  sf_mex_assign(&c8_bb_y, sf_mex_create("y", &c8_y_u, 6, 0U, 0U, 0U, 0), false);
  sf_mex_setfieldbynum(c8_f_y, 0, "discrete_signal_9", c8_bb_y, 20);
  c8_ab_u = c8_d_u.discrete_signal_10;
  c8_cb_y = NULL;
  sf_mex_assign(&c8_cb_y, sf_mex_create("y", &c8_ab_u, 6, 0U, 0U, 0U, 0), false);
  sf_mex_setfieldbynum(c8_f_y, 0, "discrete_signal_10", c8_cb_y, 21);
  sf_mex_setfieldbynum(c8_c_y, 0, "DATA", c8_f_y, 1);
  sf_mex_setcell(c8_b_y, 0, c8_c_y);
  c8_hoistedGlobal = chartInstance->c8_is_active_c8_Feb16_DLforMLACC_cs;
  c8_db_y = NULL;
  sf_mex_assign(&c8_db_y, sf_mex_create("y", &c8_hoistedGlobal, 3, 0U, 0U, 0U, 0),
                false);
  sf_mex_setcell(c8_b_y, 1, c8_db_y);
  ...
  (SFc8_Feb16_DLforMLACC_csInstanceStruct *chartInstance, const mxArray *c8_st)
{
  ...
  PRESCAN_V2X_FIXED_GENERIC_MESSAGE c8_r0;
  ...
  *(boolean_T *)&((char_T *)(PRESCAN_HEADER *)&((char_T *)chartInstance->c8_y)[0])
    [0] = c8_r0.HEADER.valid;
  *(int32_T *)&((char_T *)(PRESCAN_V2X_FIXED_GENERIC_DATA *)&((char_T *)
    chartInstance->c8_y)[8])[0] = c8_r0.DATA.messageID;
  *(int32_T *)&((char_T *)(PRESCAN_V2X_FIXED_GENERIC_DATA *)&((char_T *)
    chartInstance->c8_y)[8])[4] = c8_r0.DATA.senderID;
  *(real_T *)&((char_T *)(PRESCAN_V2X_FIXED_GENERIC_DATA *)&((char_T *)
    chartInstance->c8_y)[8])[8] = c8_r0.DATA.signal_1;
  *(real_T *)&((char_T *)(PRESCAN_V2X_FIXED_GENERIC_DATA *)&((char_T *)
    chartInstance->c8_y)[8])[16] = c8_r0.DATA.signal_2;
  *(real_T *)&((char_T *)(PRESCAN_V2X_FIXED_GENERIC_DATA *)&((char_T *)
    chartInstance->c8_y)[8])[24] = c8_r0.DATA.signal_3;
  *(real_T *)&((char_T *)(PRESCAN_V2X_FIXED_GENERIC_DATA *)&((char_T *)
    chartInstance->c8_y)[8])[32] = c8_r0.DATA.signal_4;
  *(real_T *)&((char_T *)(PRESCAN_V2X_FIXED_GENERIC_DATA *)&((char_T *)
    chartInstance->c8_y)[8])[40] = c8_r0.DATA.signal_5;
  *(real_T *)&((char_T *)(PRESCAN_V2X_FIXED_GENERIC_DATA *)&((char_T *)
    chartInstance->c8_y)[8])[48] = c8_r0.DATA.signal_6;
  *(real_T *)&((char_T *)(PRESCAN_V2X_FIXED_GENERIC_DATA *)&((char_T *)
    chartInstance->c8_y)[8])[56] = c8_r0.DATA.signal_7;
  *(real_T *)&((char_T *)(PRESCAN_V2X_FIXED_GENERIC_DATA *)&((char_T *)
    chartInstance->c8_y)[8])[64] = c8_r0.DATA.signal_8;
  *(real_T *)&((char_T *)(PRESCAN_V2X_FIXED_GENERIC_DATA *)&((char_T *)
    chartInstance->c8_y)[8])[72] = c8_r0.DATA.signal_9;
  *(real_T *)&((char_T *)(PRESCAN_V2X_FIXED_GENERIC_DATA *)&((char_T *)
    chartInstance->c8_y)[8])[80] = c8_r0.DATA.signal_10;
  *(int32_T *)&((char_T *)(PRESCAN_V2X_FIXED_GENERIC_DATA *)&((char_T *)
    chartInstance->c8_y)[8])[88] = c8_r0.DATA.discrete_signal_1;
  *(int32_T *)&((char_T *)(PRESCAN_V2X_FIXED_GENERIC_DATA *)&((char_T *)
    chartInstance->c8_y)[8])[92] = c8_r0.DATA.discrete_signal_2;
  *(int32_T *)&((char_T *)(PRESCAN_V2X_FIXED_GENERIC_DATA *)&((char_T *)
    chartInstance->c8_y)[8])[96] = c8_r0.DATA.discrete_signal_3;
  *(int32_T *)&((char_T *)(PRESCAN_V2X_FIXED_GENERIC_DATA *)&((char_T *)
    chartInstance->c8_y)[8])[100] = c8_r0.DATA.discrete_signal_4;
  *(int32_T *)&((char_T *)(PRESCAN_V2X_FIXED_GENERIC_DATA *)&((char_T *)
    chartInstance->c8_y)[8])[104] = c8_r0.DATA.discrete_signal_5;
  *(int32_T *)&((char_T *)(PRESCAN_V2X_FIXED_GENERIC_DATA *)&((char_T *)
    chartInstance->c8_y)[8])[108] = c8_r0.DATA.discrete_signal_6;
  *(int32_T *)&((char_T *)(PRESCAN_V2X_FIXED_GENERIC_DATA *)&((char_T *)
    chartInstance->c8_y)[8])[112] = c8_r0.DATA.discrete_signal_7;
  *(int32_T *)&((char_T *)(PRESCAN_V2X_FIXED_GENERIC_DATA *)&((char_T *)
    chartInstance->c8_y)[8])[116] = c8_r0.DATA.discrete_signal_8;
  *(int32_T *)&((char_T *)(PRESCAN_V2X_FIXED_GENERIC_DATA *)&((char_T *)
    chartInstance->c8_y)[8])[120] = c8_r0.DATA.discrete_signal_9;
  *(int32_T *)&((char_T *)(PRESCAN_V2X_FIXED_GENERIC_DATA *)&((char_T *)
    chartInstance->c8_y)[8])[124] = c8_r0.DATA.discrete_signal_10;
  chartInstance->c8_is_active_c8_Feb16_DLforMLACC_cs = c8_j_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c8_b_u, 1)),
     "is_active_c8_Feb16_DLforMLACC_cs");
  sf_mex_destroy(&c8_b_u);
  c8_update_debugger_state_c8_Feb16_DLforMLACC_cs(chartInstance);
  ...
  (SFc8_Feb16_DLforMLACC_csInstanceStruct *chartInstance)
{
  ...
  _sfTime_ = sf_get_time(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 7, chartInstance->c8_sfEvent);
  chartInstance->c8_sfEvent = CALL_EVENT;
  ...
  c8_chartNumber, uint32_T c8_instanceNumber)
{
  ...
  _SFD_SCRIPT_TRANSLATION(c8_chartNumber, c8_instanceNumber, 0U,
    ...
    "C:\\Users\\s2lohras\\PreScan_Experiments\\Feb16_DLforMLACC\\V2X_GENERIC_expander.m"));
}
...
static const mxArray *c8_sf_marshallOut(void *chartInstanceVoid, void *c8_inData)
{
  ...
  const mxArray *c8_b_y = NULL;
  SFc8_Feb16_DLforMLACC_csInstanceStruct *chartInstance;
  chartInstance = (SFc8_Feb16_DLforMLACC_csInstanceStruct *)chartInstanceVoid;
  ...
  *c8_inData)
{
  ...
  const mxArray *c8_c_y = NULL;
  static const char * c8_sv5[1] = { "valid" };

  boolean_T c8_d_u;
  const mxArray *c8_d_y = NULL;
  c8_PRESCAN_V2X_USER_GENERIC_DATA c8_e_u;
  const mxArray *c8_e_y = NULL;
  int32_T c8_f_u;
  const mxArray *c8_f_y = NULL;
  int32_T c8_g_u;
  ...
  c8_c_y = NULL;
  sf_mex_assign(&c8_c_y, sf_mex_createstruct("structure", 1, c8_sv5, 2, 1, 1),
                false);
  c8_d_u = c8_c_u.valid;
  c8_d_y = NULL;
  ...
  c8_e_u = c8_b_u.DATA;
  c8_e_y = NULL;
  sf_mex_assign(&c8_e_y, sf_mex_createstruct("structure", 6, c8_sv2, 2, 1, 1),
                false);
  c8_f_u = c8_e_u.messageID;
  c8_f_y = NULL;
  sf_mex_assign(&c8_f_y, sf_mex_create("y", &c8_f_u, 6, 0U, 0U, 0U, 0), false);
  sf_mex_setfieldbynum(c8_e_y, 0, "messageID", c8_f_y, 0);
  c8_g_u = c8_e_u.senderID;
  c8_g_y = NULL;
  sf_mex_assign(&c8_g_y, sf_mex_create("y", &c8_g_u, 6, 0U, 0U, 0U, 0), false);
  sf_mex_setfieldbynum(c8_e_y, 0, "senderID", c8_g_y, 1);
  c8_h_u = c8_e_u.signal_1;
  c8_h_y = NULL;
  sf_mex_assign(&c8_h_y, sf_mex_create("y", &c8_h_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setfieldbynum(c8_e_y, 0, "signal_1", c8_h_y, 2);
  c8_i_u = c8_e_u.signal_4;
  c8_i_y = NULL;
  sf_mex_assign(&c8_i_y, sf_mex_create("y", &c8_i_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setfieldbynum(c8_e_y, 0, "signal_4", c8_i_y, 3);
  c8_j_u = c8_e_u.signal_5;
  c8_j_y = NULL;
  sf_mex_assign(&c8_j_y, sf_mex_create("y", &c8_j_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setfieldbynum(c8_e_y, 0, "signal_5", c8_j_y, 4);
  c8_k_u = c8_e_u.discrete_signal_3;
  c8_k_y = NULL;
  sf_mex_assign(&c8_k_y, sf_mex_create("y", &c8_k_u, 6, 0U, 0U, 0U, 0), false);
  sf_mex_setfieldbynum(c8_e_y, 0, "discrete_signal_3", c8_k_y, 5);
  sf_mex_setfieldbynum(c8_b_y, 0, "DATA", c8_e_y, 1);
  sf_mex_assign(&c8_mxArrayOutData, c8_b_y, false);
  return c8_mxArrayOutData;
}
  ...
  *c8_inData)
{
  ...
  c8_e_u = c8_b_u.DATA;
  c8_e_y = NULL;
  sf_mex_assign(&c8_e_y, sf_mex_createstruct("structure", 22, c8_sv1, 2, 1, 1),
                false);
  c8_f_u = c8_e_u.messageID;
  c8_f_y = NULL;
  sf_mex_assign(&c8_f_y, sf_mex_create("y", &c8_f_u, 6, 0U, 0U, 0U, 0), false);
  ...
  sf_mex_assign(&c8_h_y, sf_mex_create("y", &c8_h_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setfieldbynum(c8_e_y, 0, "signal_1", c8_h_y, 2);
  c8_i_u = c8_e_u.signal_2;
  c8_i_y = NULL;
  sf_mex_assign(&c8_i_y, sf_mex_create("y", &c8_i_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setfieldbynum(c8_e_y, 0, "signal_2", c8_i_y, 3);
  c8_j_u = c8_e_u.signal_3;
  c8_j_y = NULL;
  sf_mex_assign(&c8_j_y, sf_mex_create("y", &c8_j_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setfieldbynum(c8_e_y, 0, "signal_3", c8_j_y, 4);
  c8_k_u = c8_e_u.signal_4;
  c8_k_y = NULL;
  sf_mex_assign(&c8_k_y, sf_mex_create("y", &c8_k_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setfieldbynum(c8_e_y, 0, "signal_4", c8_k_y, 5);
  c8_l_u = c8_e_u.signal_5;
  c8_l_y = NULL;
  sf_mex_assign(&c8_l_y, sf_mex_create("y", &c8_l_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setfieldbynum(c8_e_y, 0, "signal_5", c8_l_y, 6);
  c8_m_u = c8_e_u.signal_6;
  c8_m_y = NULL;
  sf_mex_assign(&c8_m_y, sf_mex_create("y", &c8_m_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setfieldbynum(c8_e_y, 0, "signal_6", c8_m_y, 7);
  c8_n_u = c8_e_u.signal_7;
  c8_n_y = NULL;
  sf_mex_assign(&c8_n_y, sf_mex_create("y", &c8_n_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setfieldbynum(c8_e_y, 0, "signal_7", c8_n_y, 8);
  c8_o_u = c8_e_u.signal_8;
  c8_o_y = NULL;
  sf_mex_assign(&c8_o_y, sf_mex_create("y", &c8_o_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setfieldbynum(c8_e_y, 0, "signal_8", c8_o_y, 9);
  c8_p_u = c8_e_u.signal_9;
  c8_p_y = NULL;
  sf_mex_assign(&c8_p_y, sf_mex_create("y", &c8_p_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setfieldbynum(c8_e_y, 0, "signal_9", c8_p_y, 10);
  c8_q_u = c8_e_u.signal_10;
  c8_q_y = NULL;
  sf_mex_assign(&c8_q_y, sf_mex_create("y", &c8_q_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setfieldbynum(c8_e_y, 0, "signal_10", c8_q_y, 11);
  c8_r_u = c8_e_u.discrete_signal_1;
  c8_r_y = NULL;
  sf_mex_assign(&c8_r_y, sf_mex_create("y", &c8_r_u, 6, 0U, 0U, 0U, 0), false);
  sf_mex_setfieldbynum(c8_e_y, 0, "discrete_signal_1", c8_r_y, 12);
  c8_s_u = c8_e_u.discrete_signal_2;
  c8_s_y = NULL;
  sf_mex_assign(&c8_s_y, sf_mex_create("y", &c8_s_u, 6, 0U, 0U, 0U, 0), false);
  sf_mex_setfieldbynum(c8_e_y, 0, "discrete_signal_2", c8_s_y, 13);
  c8_t_u = c8_e_u.discrete_signal_3;
  c8_t_y = NULL;
  sf_mex_assign(&c8_t_y, sf_mex_create("y", &c8_t_u, 6, 0U, 0U, 0U, 0), false);
  sf_mex_setfieldbynum(c8_e_y, 0, "discrete_signal_3", c8_t_y, 14);
  c8_u_u = c8_e_u.discrete_signal_4;
  c8_u_y = NULL;
  sf_mex_assign(&c8_u_y, sf_mex_create("y", &c8_u_u, 6, 0U, 0U, 0U, 0), false);
  sf_mex_setfieldbynum(c8_e_y, 0, "discrete_signal_4", c8_u_y, 15);
  c8_v_u = c8_e_u.discrete_signal_5;
  c8_v_y = NULL;
  sf_mex_assign(&c8_v_y, sf_mex_create("y", &c8_v_u, 6, 0U, 0U, 0U, 0), false);
  sf_mex_setfieldbynum(c8_e_y, 0, "discrete_signal_5", c8_v_y, 16);
  c8_w_u = c8_e_u.discrete_signal_6;
  c8_w_y = NULL;
  sf_mex_assign(&c8_w_y, sf_mex_create("y", &c8_w_u, 6, 0U, 0U, 0U, 0), false);
  sf_mex_setfieldbynum(c8_e_y, 0, "discrete_signal_6", c8_w_y, 17);
  c8_x_u = c8_e_u.discrete_signal_7;
  c8_x_y = NULL;
  sf_mex_assign(&c8_x_y, sf_mex_create("y", &c8_x_u, 6, 0U, 0U, 0U, 0), false);
  sf_mex_setfieldbynum(c8_e_y, 0, "discrete_signal_7", c8_x_y, 18);
  c8_y_u = c8_e_u.discrete_signal_8;
  c8_y_y = NULL;
  sf_mex_assign(&c8_y_y, sf_mex_create("y", &c8_y_u, 6, 0U, 0U, 0U, 0), false);
  sf_mex_setfieldbynum(c8_e_y, 0, "discrete_signal_8", c8_y_y, 19);
  c8_ab_u = c8_e_u.discrete_signal_9;
  c8_ab_y = NULL;
  sf_mex_assign(&c8_ab_y, sf_mex_create("y", &c8_ab_u, 6, 0U, 0U, 0U, 0), false);
  sf_mex_setfieldbynum(c8_e_y, 0, "discrete_signal_9", c8_ab_y, 20);
  c8_bb_u = c8_e_u.discrete_signal_10;
  c8_bb_y = NULL;
  sf_mex_assign(&c8_bb_y, sf_mex_create("y", &c8_bb_u, 6, 0U, 0U, 0U, 0), false);
  sf_mex_setfieldbynum(c8_e_y, 0, "discrete_signal_10", c8_bb_y, 21);
  sf_mex_setfieldbynum(c8_b_y, 0, "DATA", c8_e_y, 1);
  sf_mex_assign(&c8_mxArrayOutData, c8_b_y, false);
  return c8_mxArrayOutData;
}
  ...
  PRESCAN_V2X_FIXED_GENERIC_MESSAGE *c8_b_y)
{
  ...
  c8_thisId.bParentIsCell = false;
  sf_mex_check_struct(c8_parentId, c8_b_u, 2, c8_sv3, 0U, NULL);
  ...
  *c8_inData)
{
  ...
  c8_mxArrayOutData = NULL;
  c8_mxArrayOutData = NULL;
  c8_b_u = *(PRESCAN_V2X_FIXED_GENERIC_DATA *)c8_inData;
  c8_b_y = NULL;
  sf_mex_assign(&c8_b_y, sf_mex_createstruct("structure", 22, c8_sv1, 2, 1, 1),
                false);
...
{
  const mxArray *c8_mxArrayOutData;
  c8_PRESCAN_V2X_USER_GENERIC_DATA c8_b_u;
  const mxArray *c8_b_y = NULL;
  int32_T c8_c_u;
  const mxArray *c8_c_y = NULL;
  int32_T c8_d_u;
  ...
  c8_mxArrayOutData = NULL;
  c8_mxArrayOutData = NULL;
  c8_b_u = *(c8_PRESCAN_V2X_USER_GENERIC_DATA *)c8_inData;
  c8_b_y = NULL;
  sf_mex_assign(&c8_b_y, sf_mex_createstruct("structure", 6, c8_sv2, 2, 1, 1),
                false);
  c8_c_u = c8_b_u.messageID;
  c8_c_y = NULL;
  sf_mex_assign(&c8_c_y, sf_mex_create("y", &c8_c_u, 6, 0U, 0U, 0U, 0), false);
...
const mxArray *sf_c8_Feb16_DLforMLACC_cs_get_eml_resolved_functions_info(void)
{
  const mxArray *c8_nameCaptureInfo = NULL;
  const char * c8_data[4] = {
    "789cc5535d4ec240101e14893e6078303e79061a30d1c427a0162102127ec4604c2d6590c6ee96ec16addec11b78086fe3752c8542d9b8e9031127d94cbf7e9b"
    "f966bf9d8544b59e0080437fedfaeb2b0541a4e709328bbc03eb21f209490e630f92c1bfb4c07f2eb2e950173d770e6c8b62634a06c87c400d82cb32438758d4",
    "a06ee76d82c0903bf60b0e036664d9d8b108d69c08a8583e20e508b504336af6ad8ed17c6e4f09b0315fb56b470144fc79949c3f19e38f18a23fe2be38bd548c"
    "5edc7d1cc07e54bd10ea79927a71e70beb1f49f432027f9bbfd3afb486d6aaaa3a7a13830e83cbded8e7503725e0551f7386bb6c6aba91b9df50af29d55be7ef",
    "b507f542e972645ce179db1933832b4d866dd3a0bae64d90f9b3495dae9471903bd32f6b2387d56b4555557e732c4bb63727858ff4c97771bb73b9ed77f07f7a"
    "9bbebb63895e46e0fbfd4af3bcfbda31f9e94d29c77ad7ef4fad5e69d54738a7329db83e4082ffbafe0fe9456436",
    "" };
  ...
  char_T *c8_identifier)
{
  ...
  c8_b_y = c8_k_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c8_b_is_active_c8_Feb16_DLforMLACC_cs), &c8_thisId);
  sf_mex_destroy(&c8_b_is_active_c8_Feb16_DLforMLACC_cs);
  return c8_b_y;
}
...
/* SFunction Glue Code */
void sf_c8_Feb16_DLforMLACC_cs_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c8_Feb16_DLforMLACC_cs_get_post_codegen_info(void);
mxArray *sf_c8_Feb16_DLforMLACC_cs_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c8_Feb16_DLforMLACC_cs_get_post_codegen_info
      ();
...
mxArray *sf_c8_Feb16_DLforMLACC_cs_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c8_Feb16_DLforMLACC_cs_jit_fallback_info(void)
{
...
mxArray *sf_c8_Feb16_DLforMLACC_cs_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c8_Feb16_DLforMLACC_cs(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c8_Feb16_DLforMLACC_cs\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c8_Feb16_DLforMLACC_cs_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc8_Feb16_DLforMLACC_csInstanceStruct *chartInstance =
      (SFc8_Feb16_DLforMLACC_csInstanceStruct *)sf_get_chart_instance_ptr(S);
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        chartAlreadyPresent = sf_debug_initialize_chart
          (sfGlobalDebugInstanceStruct,
           _Feb16_DLforMLACC_csMachineNumber_,
           8,
           1,
           1,
           0,
        ...
        init_script_number_translation(_Feb16_DLforMLACC_csMachineNumber_,
          chartInstance->chartNumber,chartInstance->instanceNumber);
        if (chartAlreadyPresent==0) {
          /* this is the first instance */
          sf_debug_set_chart_disable_implicit_casting
            (sfGlobalDebugInstanceStruct,_Feb16_DLforMLACC_csMachineNumber_,
      ...
      sf_debug_reset_current_state_configuration(sfGlobalDebugInstanceStruct,
        _Feb16_DLforMLACC_csMachineNumber_,chartInstance->chartNumber,
        chartInstance->instanceNumber);
    }
  }
}
...
static void sf_opaque_initialize_c8_Feb16_DLforMLACC_cs(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc8_Feb16_DLforMLACC_csInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c8_Feb16_DLforMLACC_cs
    ((SFc8_Feb16_DLforMLACC_csInstanceStruct*) chartInstanceVar);
  initialize_c8_Feb16_DLforMLACC_cs((SFc8_Feb16_DLforMLACC_csInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c8_Feb16_DLforMLACC_cs(void *chartInstanceVar)
{
  enable_c8_Feb16_DLforMLACC_cs((SFc8_Feb16_DLforMLACC_csInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c8_Feb16_DLforMLACC_cs(void *chartInstanceVar)
{
  disable_c8_Feb16_DLforMLACC_cs((SFc8_Feb16_DLforMLACC_csInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c8_Feb16_DLforMLACC_cs(void *chartInstanceVar)
{
  sf_gateway_c8_Feb16_DLforMLACC_cs((SFc8_Feb16_DLforMLACC_csInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c8_Feb16_DLforMLACC_cs(SimStruct*
  S)
{
  return get_sim_state_c8_Feb16_DLforMLACC_cs
    ((SFc8_Feb16_DLforMLACC_csInstanceStruct *)sf_get_chart_instance_ptr(S));/* raw sim ctx */
}

static void sf_opaque_set_sim_state_c8_Feb16_DLforMLACC_cs(SimStruct* S, const
  mxArray *st)
{
  set_sim_state_c8_Feb16_DLforMLACC_cs((SFc8_Feb16_DLforMLACC_csInstanceStruct*)
    sf_get_chart_instance_ptr(S), st);
}

static void sf_opaque_terminate_c8_Feb16_DLforMLACC_cs(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc8_Feb16_DLforMLACC_csInstanceStruct*) chartInstanceVar
      )->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_Feb16_DLforMLACC_cs_optimization_info();
    }

    finalize_c8_Feb16_DLforMLACC_cs((SFc8_Feb16_DLforMLACC_csInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc8_Feb16_DLforMLACC_cs((SFc8_Feb16_DLforMLACC_csInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c8_Feb16_DLforMLACC_cs(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c8_Feb16_DLforMLACC_cs(SimStruct *S)
{
  ...
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_Feb16_DLforMLACC_cs_optimization_info
  ...
  ssSetChecksum0(S,(3470596077U));
  ssSetChecksum1(S,(2928266647U));
  ssSetChecksum2(S,(927579290U));
  ssSetChecksum3(S,(975215298U));
...
static void mdlRTW_c8_Feb16_DLforMLACC_cs(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c8_Feb16_DLforMLACC_cs(SimStruct *S)
{
  SFc8_Feb16_DLforMLACC_csInstanceStruct *chartInstance;
  chartInstance = (SFc8_Feb16_DLforMLACC_csInstanceStruct *)utMalloc(sizeof
    (SFc8_Feb16_DLforMLACC_csInstanceStruct));
  if (chartInstance==NULL) {
    sf_mex_error_message("Could not allocate memory for chart instance.");
  }

  memset(chartInstance, 0, sizeof(SFc8_Feb16_DLforMLACC_csInstanceStruct));
  chartInstance->chartInfo.chartInstance = chartInstance;
  chartInstance->chartInfo.isEMLChart = 1;
  chartInstance->chartInfo.chartInitialized = 0;
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c8_Feb16_DLforMLACC_cs;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c8_Feb16_DLforMLACC_cs;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c8_Feb16_DLforMLACC_cs;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c8_Feb16_DLforMLACC_cs;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c8_Feb16_DLforMLACC_cs;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c8_Feb16_DLforMLACC_cs;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c8_Feb16_DLforMLACC_cs;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c8_Feb16_DLforMLACC_cs;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c8_Feb16_DLforMLACC_cs;
  chartInstance->chartInfo.mdlStart = mdlStart_c8_Feb16_DLforMLACC_cs;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c8_Feb16_DLforMLACC_cs;
  ...
  mdl_start_c8_Feb16_DLforMLACC_cs(chartInstance);
}

void c8_Feb16_DLforMLACC_cs_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c8_Feb16_DLforMLACC_cs(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c8_Feb16_DLforMLACC_cs(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c8_Feb16_DLforMLACC_cs(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c8_Feb16_DLforMLACC_cs_method_dispatcher.\n"
