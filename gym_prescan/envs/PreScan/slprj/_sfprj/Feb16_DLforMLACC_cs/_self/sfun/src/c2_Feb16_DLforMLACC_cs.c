...
#include "c2_Feb16_DLforMLACC_cs.h"
...
static const char * c2_sv1[6] = { "messageID", "senderID", "signal_1",
  "signal_4", "signal_5", "discrete_signal_3" };

static const char * c2_sv2[22] = { "messageID", "senderID", "signal_1",
...
static const char * c2_sv3[2] = { "HEADER", "DATA" };

/* Function Declarations */
static void initialize_c2_Feb16_DLforMLACC_cs
  (SFc2_Feb16_DLforMLACC_csInstanceStruct *chartInstance);
static void initialize_params_c2_Feb16_DLforMLACC_cs
  (SFc2_Feb16_DLforMLACC_csInstanceStruct *chartInstance);
static void enable_c2_Feb16_DLforMLACC_cs(SFc2_Feb16_DLforMLACC_csInstanceStruct
  *chartInstance);
static void disable_c2_Feb16_DLforMLACC_cs
  (SFc2_Feb16_DLforMLACC_csInstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_Feb16_DLforMLACC_cs
  (SFc2_Feb16_DLforMLACC_csInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_Feb16_DLforMLACC_cs
  (SFc2_Feb16_DLforMLACC_csInstanceStruct *chartInstance);
static void set_sim_state_c2_Feb16_DLforMLACC_cs
  (SFc2_Feb16_DLforMLACC_csInstanceStruct *chartInstance, const mxArray *c2_st);
static void finalize_c2_Feb16_DLforMLACC_cs
  (SFc2_Feb16_DLforMLACC_csInstanceStruct *chartInstance);
static void sf_gateway_c2_Feb16_DLforMLACC_cs
  (SFc2_Feb16_DLforMLACC_csInstanceStruct *chartInstance);
static void mdl_start_c2_Feb16_DLforMLACC_cs
  (SFc2_Feb16_DLforMLACC_csInstanceStruct *chartInstance);
static void initSimStructsc2_Feb16_DLforMLACC_cs
  (SFc2_Feb16_DLforMLACC_csInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber, uint32_T c2_instanceNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static real_T c2_emlrt_marshallIn(SFc2_Feb16_DLforMLACC_csInstanceStruct
...
static c2_PRESCAN_V2X_USER_GENERIC_MESSAGE c2_b_emlrt_marshallIn
  (SFc2_Feb16_DLforMLACC_csInstanceStruct *chartInstance, const mxArray *c2_b_y,
   const char_T *c2_identifier);
static c2_PRESCAN_V2X_USER_GENERIC_MESSAGE c2_c_emlrt_marshallIn
  (SFc2_Feb16_DLforMLACC_csInstanceStruct *chartInstance, const mxArray *c2_b_u,
   const emlrtMsgIdentifier *c2_parentId);
static PRESCAN_HEADER c2_d_emlrt_marshallIn
  (SFc2_Feb16_DLforMLACC_csInstanceStruct *chartInstance, const mxArray *c2_b_u,
   const emlrtMsgIdentifier *c2_parentId);
static boolean_T c2_e_emlrt_marshallIn(SFc2_Feb16_DLforMLACC_csInstanceStruct
  *chartInstance, const mxArray *c2_b_u, const emlrtMsgIdentifier *c2_parentId);
static c2_PRESCAN_V2X_USER_GENERIC_DATA c2_f_emlrt_marshallIn
  (SFc2_Feb16_DLforMLACC_csInstanceStruct *chartInstance, const mxArray *c2_b_u,
   const emlrtMsgIdentifier *c2_parentId);
static int32_T c2_g_emlrt_marshallIn(SFc2_Feb16_DLforMLACC_csInstanceStruct
  *chartInstance, const mxArray *c2_b_u, const emlrtMsgIdentifier *c2_parentId);
...
static const mxArray *c2_f_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_h_emlrt_marshallIn(SFc2_Feb16_DLforMLACC_csInstanceStruct
  *chartInstance, const mxArray *c2_b_u, const emlrtMsgIdentifier *c2_parentId,
  PRESCAN_V2X_FIXED_GENERIC_DATA *c2_b_y);
static void c2_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static void c2_i_emlrt_marshallIn(SFc2_Feb16_DLforMLACC_csInstanceStruct
  *chartInstance, const mxArray *c2_b_u, const emlrtMsgIdentifier *c2_parentId,
...
static uint8_T c2_j_emlrt_marshallIn(SFc2_Feb16_DLforMLACC_csInstanceStruct
  *chartInstance, const mxArray *c2_b_is_active_c2_Feb16_DLforMLACC_cs, const
  char_T *c2_identifier);
static uint8_T c2_k_emlrt_marshallIn(SFc2_Feb16_DLforMLACC_csInstanceStruct
  *chartInstance, const mxArray *c2_b_u, const emlrtMsgIdentifier *c2_parentId);
static void init_dsm_address_info(SFc2_Feb16_DLforMLACC_csInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc2_Feb16_DLforMLACC_csInstanceStruct
  *chartInstance);
  ...
  (SFc2_Feb16_DLforMLACC_csInstanceStruct *chartInstance)
{
  if (sf_is_first_init_cond(chartInstance->S)) {
    initSimStructsc2_Feb16_DLforMLACC_cs(chartInstance);
  ...
  chartInstance->c2_is_active_c2_Feb16_DLforMLACC_cs = 0U;
  ...
  (SFc2_Feb16_DLforMLACC_csInstanceStruct *chartInstance)
{
  ...
  c2_PRESCAN_V2X_USER_GENERIC_DATA c2_d_u;
  ...
  c2_d_y = NULL;
  sf_mex_assign(&c2_d_y, sf_mex_createstruct("structure", 1, c2_sv4, 2, 1, 1),
                false);
  c2_c_u = c2_b_u.valid;
  c2_e_y = NULL;
  ...
  c2_d_u.messageID = *(int32_T *)&((char_T *)(c2_PRESCAN_V2X_USER_GENERIC_DATA *)
    &((char_T *)chartInstance->c2_y)[8])[0];
  c2_d_u.senderID = *(int32_T *)&((char_T *)(c2_PRESCAN_V2X_USER_GENERIC_DATA *)
    &((char_T *)chartInstance->c2_y)[8])[4];
  c2_d_u.signal_1 = *(real_T *)&((char_T *)(c2_PRESCAN_V2X_USER_GENERIC_DATA *)
    &((char_T *)chartInstance->c2_y)[8])[8];
  c2_d_u.signal_4 = *(real_T *)&((char_T *)(c2_PRESCAN_V2X_USER_GENERIC_DATA *)
    &((char_T *)chartInstance->c2_y)[8])[16];
  c2_d_u.signal_5 = *(real_T *)&((char_T *)(c2_PRESCAN_V2X_USER_GENERIC_DATA *)
    &((char_T *)chartInstance->c2_y)[8])[24];
  c2_d_u.discrete_signal_3 = *(int32_T *)&((char_T *)
    (c2_PRESCAN_V2X_USER_GENERIC_DATA *)&((char_T *)chartInstance->c2_y)[8])[32];
  c2_f_y = NULL;
  sf_mex_assign(&c2_f_y, sf_mex_createstruct("structure", 6, c2_sv1, 2, 1, 1),
                false);
  c2_e_u = c2_d_u.messageID;
  c2_g_y = NULL;
  sf_mex_assign(&c2_g_y, sf_mex_create("y", &c2_e_u, 6, 0U, 0U, 0U, 0), false);
  sf_mex_setfieldbynum(c2_f_y, 0, "messageID", c2_g_y, 0);
  c2_f_u = c2_d_u.senderID;
  c2_h_y = NULL;
  sf_mex_assign(&c2_h_y, sf_mex_create("y", &c2_f_u, 6, 0U, 0U, 0U, 0), false);
  sf_mex_setfieldbynum(c2_f_y, 0, "senderID", c2_h_y, 1);
  c2_g_u = c2_d_u.signal_1;
  c2_i_y = NULL;
  sf_mex_assign(&c2_i_y, sf_mex_create("y", &c2_g_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setfieldbynum(c2_f_y, 0, "signal_1", c2_i_y, 2);
  c2_h_u = c2_d_u.signal_4;
  c2_j_y = NULL;
  sf_mex_assign(&c2_j_y, sf_mex_create("y", &c2_h_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setfieldbynum(c2_f_y, 0, "signal_4", c2_j_y, 3);
  c2_i_u = c2_d_u.signal_5;
  c2_k_y = NULL;
  sf_mex_assign(&c2_k_y, sf_mex_create("y", &c2_i_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setfieldbynum(c2_f_y, 0, "signal_5", c2_k_y, 4);
  c2_j_u = c2_d_u.discrete_signal_3;
  c2_l_y = NULL;
  sf_mex_assign(&c2_l_y, sf_mex_create("y", &c2_j_u, 6, 0U, 0U, 0U, 0), false);
  sf_mex_setfieldbynum(c2_f_y, 0, "discrete_signal_3", c2_l_y, 5);
  sf_mex_setfieldbynum(c2_c_y, 0, "DATA", c2_f_y, 1);
  sf_mex_setcell(c2_b_y, 0, c2_c_y);
  c2_hoistedGlobal = chartInstance->c2_is_active_c2_Feb16_DLforMLACC_cs;
  c2_m_y = NULL;
  sf_mex_assign(&c2_m_y, sf_mex_create("y", &c2_hoistedGlobal, 3, 0U, 0U, 0U, 0),
                false);
  sf_mex_setcell(c2_b_y, 1, c2_m_y);
  ...
  (SFc2_Feb16_DLforMLACC_csInstanceStruct *chartInstance, const mxArray *c2_st)
{
  ...
  c2_PRESCAN_V2X_USER_GENERIC_MESSAGE c2_r0;
  chartInstance->c2_doneDoubleBufferReInit = true;
  c2_b_u = sf_mex_dup(c2_st);
  c2_r0 = c2_b_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c2_b_u,
    0)), "y");
  *(boolean_T *)&((char_T *)(PRESCAN_HEADER *)&((char_T *)chartInstance->c2_y)[0])
    [0] = c2_r0.HEADER.valid;
  *(int32_T *)&((char_T *)(c2_PRESCAN_V2X_USER_GENERIC_DATA *)&((char_T *)
    chartInstance->c2_y)[8])[0] = c2_r0.DATA.messageID;
  *(int32_T *)&((char_T *)(c2_PRESCAN_V2X_USER_GENERIC_DATA *)&((char_T *)
    chartInstance->c2_y)[8])[4] = c2_r0.DATA.senderID;
  *(real_T *)&((char_T *)(c2_PRESCAN_V2X_USER_GENERIC_DATA *)&((char_T *)
    chartInstance->c2_y)[8])[8] = c2_r0.DATA.signal_1;
  *(real_T *)&((char_T *)(c2_PRESCAN_V2X_USER_GENERIC_DATA *)&((char_T *)
    chartInstance->c2_y)[8])[16] = c2_r0.DATA.signal_4;
  *(real_T *)&((char_T *)(c2_PRESCAN_V2X_USER_GENERIC_DATA *)&((char_T *)
    chartInstance->c2_y)[8])[24] = c2_r0.DATA.signal_5;
  *(int32_T *)&((char_T *)(c2_PRESCAN_V2X_USER_GENERIC_DATA *)&((char_T *)
    chartInstance->c2_y)[8])[32] = c2_r0.DATA.discrete_signal_3;
  chartInstance->c2_is_active_c2_Feb16_DLforMLACC_cs = c2_j_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c2_b_u, 1)),
     "is_active_c2_Feb16_DLforMLACC_cs");
  sf_mex_destroy(&c2_b_u);
  c2_update_debugger_state_c2_Feb16_DLforMLACC_cs(chartInstance);
  ...
  c2_chartNumber, uint32_T c2_instanceNumber)
{
  ...
  _SFD_SCRIPT_TRANSLATION(c2_chartNumber, c2_instanceNumber, 0U,
    ...
    "C:\\Users\\s2lohras\\PreScan_Experiments\\Feb16_DLforMLACC\\V2X_GENERIC_filter.m"));
}
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_b_y = NULL;
  SFc2_Feb16_DLforMLACC_csInstanceStruct *chartInstance;
  chartInstance = (SFc2_Feb16_DLforMLACC_csInstanceStruct *)chartInstanceVoid;
  ...
  *c2_inData)
{
  ...
  const mxArray *c2_c_y = NULL;
  static const char * c2_sv5[1] = { "valid" };

  boolean_T c2_d_u;
  const mxArray *c2_d_y = NULL;
  PRESCAN_V2X_FIXED_GENERIC_DATA c2_e_u;
  const mxArray *c2_e_y = NULL;
  int32_T c2_f_u;
  const mxArray *c2_f_y = NULL;
  int32_T c2_g_u;
  ...
  c2_c_y = NULL;
  sf_mex_assign(&c2_c_y, sf_mex_createstruct("structure", 1, c2_sv5, 2, 1, 1),
                false);
  c2_d_u = c2_c_u.valid;
  c2_d_y = NULL;
  ...
  c2_e_u = c2_b_u.DATA;
  c2_e_y = NULL;
  sf_mex_assign(&c2_e_y, sf_mex_createstruct("structure", 22, c2_sv2, 2, 1, 1),
                false);
  c2_f_u = c2_e_u.messageID;
  c2_f_y = NULL;
  sf_mex_assign(&c2_f_y, sf_mex_create("y", &c2_f_u, 6, 0U, 0U, 0U, 0), false);
  sf_mex_setfieldbynum(c2_e_y, 0, "messageID", c2_f_y, 0);
  c2_g_u = c2_e_u.senderID;
  c2_g_y = NULL;
  sf_mex_assign(&c2_g_y, sf_mex_create("y", &c2_g_u, 6, 0U, 0U, 0U, 0), false);
  sf_mex_setfieldbynum(c2_e_y, 0, "senderID", c2_g_y, 1);
  c2_h_u = c2_e_u.signal_1;
  c2_h_y = NULL;
  sf_mex_assign(&c2_h_y, sf_mex_create("y", &c2_h_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setfieldbynum(c2_e_y, 0, "signal_1", c2_h_y, 2);
  c2_i_u = c2_e_u.signal_2;
  c2_i_y = NULL;
  sf_mex_assign(&c2_i_y, sf_mex_create("y", &c2_i_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setfieldbynum(c2_e_y, 0, "signal_2", c2_i_y, 3);
  c2_j_u = c2_e_u.signal_3;
  c2_j_y = NULL;
  sf_mex_assign(&c2_j_y, sf_mex_create("y", &c2_j_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setfieldbynum(c2_e_y, 0, "signal_3", c2_j_y, 4);
  c2_k_u = c2_e_u.signal_4;
  c2_k_y = NULL;
  sf_mex_assign(&c2_k_y, sf_mex_create("y", &c2_k_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setfieldbynum(c2_e_y, 0, "signal_4", c2_k_y, 5);
  c2_l_u = c2_e_u.signal_5;
  c2_l_y = NULL;
  sf_mex_assign(&c2_l_y, sf_mex_create("y", &c2_l_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setfieldbynum(c2_e_y, 0, "signal_5", c2_l_y, 6);
  c2_m_u = c2_e_u.signal_6;
  c2_m_y = NULL;
  sf_mex_assign(&c2_m_y, sf_mex_create("y", &c2_m_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setfieldbynum(c2_e_y, 0, "signal_6", c2_m_y, 7);
  c2_n_u = c2_e_u.signal_7;
  c2_n_y = NULL;
  sf_mex_assign(&c2_n_y, sf_mex_create("y", &c2_n_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setfieldbynum(c2_e_y, 0, "signal_7", c2_n_y, 8);
  c2_o_u = c2_e_u.signal_8;
  c2_o_y = NULL;
  sf_mex_assign(&c2_o_y, sf_mex_create("y", &c2_o_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setfieldbynum(c2_e_y, 0, "signal_8", c2_o_y, 9);
  c2_p_u = c2_e_u.signal_9;
  c2_p_y = NULL;
  sf_mex_assign(&c2_p_y, sf_mex_create("y", &c2_p_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setfieldbynum(c2_e_y, 0, "signal_9", c2_p_y, 10);
  c2_q_u = c2_e_u.signal_10;
  c2_q_y = NULL;
  sf_mex_assign(&c2_q_y, sf_mex_create("y", &c2_q_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setfieldbynum(c2_e_y, 0, "signal_10", c2_q_y, 11);
  c2_r_u = c2_e_u.discrete_signal_1;
  c2_r_y = NULL;
  sf_mex_assign(&c2_r_y, sf_mex_create("y", &c2_r_u, 6, 0U, 0U, 0U, 0), false);
  sf_mex_setfieldbynum(c2_e_y, 0, "discrete_signal_1", c2_r_y, 12);
  c2_s_u = c2_e_u.discrete_signal_2;
  c2_s_y = NULL;
  sf_mex_assign(&c2_s_y, sf_mex_create("y", &c2_s_u, 6, 0U, 0U, 0U, 0), false);
  sf_mex_setfieldbynum(c2_e_y, 0, "discrete_signal_2", c2_s_y, 13);
  c2_t_u = c2_e_u.discrete_signal_3;
  c2_t_y = NULL;
  sf_mex_assign(&c2_t_y, sf_mex_create("y", &c2_t_u, 6, 0U, 0U, 0U, 0), false);
  sf_mex_setfieldbynum(c2_e_y, 0, "discrete_signal_3", c2_t_y, 14);
  c2_u_u = c2_e_u.discrete_signal_4;
  c2_u_y = NULL;
  sf_mex_assign(&c2_u_y, sf_mex_create("y", &c2_u_u, 6, 0U, 0U, 0U, 0), false);
  sf_mex_setfieldbynum(c2_e_y, 0, "discrete_signal_4", c2_u_y, 15);
  c2_v_u = c2_e_u.discrete_signal_5;
  c2_v_y = NULL;
  sf_mex_assign(&c2_v_y, sf_mex_create("y", &c2_v_u, 6, 0U, 0U, 0U, 0), false);
  sf_mex_setfieldbynum(c2_e_y, 0, "discrete_signal_5", c2_v_y, 16);
  c2_w_u = c2_e_u.discrete_signal_6;
  c2_w_y = NULL;
  sf_mex_assign(&c2_w_y, sf_mex_create("y", &c2_w_u, 6, 0U, 0U, 0U, 0), false);
  sf_mex_setfieldbynum(c2_e_y, 0, "discrete_signal_6", c2_w_y, 17);
  c2_x_u = c2_e_u.discrete_signal_7;
  c2_x_y = NULL;
  sf_mex_assign(&c2_x_y, sf_mex_create("y", &c2_x_u, 6, 0U, 0U, 0U, 0), false);
  sf_mex_setfieldbynum(c2_e_y, 0, "discrete_signal_7", c2_x_y, 18);
  c2_y_u = c2_e_u.discrete_signal_8;
  c2_y_y = NULL;
  sf_mex_assign(&c2_y_y, sf_mex_create("y", &c2_y_u, 6, 0U, 0U, 0U, 0), false);
  sf_mex_setfieldbynum(c2_e_y, 0, "discrete_signal_8", c2_y_y, 19);
  c2_ab_u = c2_e_u.discrete_signal_9;
  c2_ab_y = NULL;
  sf_mex_assign(&c2_ab_y, sf_mex_create("y", &c2_ab_u, 6, 0U, 0U, 0U, 0), false);
  sf_mex_setfieldbynum(c2_e_y, 0, "discrete_signal_9", c2_ab_y, 20);
  c2_bb_u = c2_e_u.discrete_signal_10;
  c2_bb_y = NULL;
  sf_mex_assign(&c2_bb_y, sf_mex_create("y", &c2_bb_u, 6, 0U, 0U, 0U, 0), false);
  sf_mex_setfieldbynum(c2_e_y, 0, "discrete_signal_10", c2_bb_y, 21);
  sf_mex_setfieldbynum(c2_b_y, 0, "DATA", c2_e_y, 1);
  sf_mex_assign(&c2_mxArrayOutData, c2_b_y, false);
  return c2_mxArrayOutData;
}
  ...
  *c2_inData)
{
  ...
  c2_e_u = c2_b_u.DATA;
  c2_e_y = NULL;
  sf_mex_assign(&c2_e_y, sf_mex_createstruct("structure", 6, c2_sv1, 2, 1, 1),
                false);
  c2_f_u = c2_e_u.messageID;
  c2_f_y = NULL;
  sf_mex_assign(&c2_f_y, sf_mex_create("y", &c2_f_u, 6, 0U, 0U, 0U, 0), false);
  ...
  sf_mex_assign(&c2_h_y, sf_mex_create("y", &c2_h_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setfieldbynum(c2_e_y, 0, "signal_1", c2_h_y, 2);
  c2_i_u = c2_e_u.signal_4;
  c2_i_y = NULL;
  sf_mex_assign(&c2_i_y, sf_mex_create("y", &c2_i_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setfieldbynum(c2_e_y, 0, "signal_4", c2_i_y, 3);
  c2_j_u = c2_e_u.signal_5;
  c2_j_y = NULL;
  sf_mex_assign(&c2_j_y, sf_mex_create("y", &c2_j_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setfieldbynum(c2_e_y, 0, "signal_5", c2_j_y, 4);
  c2_k_u = c2_e_u.discrete_signal_3;
  c2_k_y = NULL;
  sf_mex_assign(&c2_k_y, sf_mex_create("y", &c2_k_u, 6, 0U, 0U, 0U, 0), false);
  sf_mex_setfieldbynum(c2_e_y, 0, "discrete_signal_3", c2_k_y, 5);
  sf_mex_setfieldbynum(c2_b_y, 0, "DATA", c2_e_y, 1);
  sf_mex_assign(&c2_mxArrayOutData, c2_b_y, false);
  return c2_mxArrayOutData;
}
   ...
   const emlrtMsgIdentifier *c2_parentId)
{
  ...
  c2_thisId.bParentIsCell = false;
  sf_mex_check_struct(c2_parentId, c2_b_u, 2, c2_sv3, 0U, NULL);
  ...
  *c2_inData)
{
  ...
  c2_mxArrayOutData = NULL;
  c2_mxArrayOutData = NULL;
  c2_b_u = *(c2_PRESCAN_V2X_USER_GENERIC_DATA *)c2_inData;
  c2_b_y = NULL;
  sf_mex_assign(&c2_b_y, sf_mex_createstruct("structure", 6, c2_sv1, 2, 1, 1),
                false);
...
{
  const mxArray *c2_mxArrayOutData;
  PRESCAN_V2X_FIXED_GENERIC_DATA c2_b_u;
  const mxArray *c2_b_y = NULL;
  int32_T c2_c_u;
  const mxArray *c2_c_y = NULL;
  int32_T c2_d_u;
  ...
  c2_mxArrayOutData = NULL;
  c2_mxArrayOutData = NULL;
  c2_b_u = *(PRESCAN_V2X_FIXED_GENERIC_DATA *)c2_inData;
  c2_b_y = NULL;
  sf_mex_assign(&c2_b_y, sf_mex_createstruct("structure", 22, c2_sv2, 2, 1, 1),
                false);
  c2_c_u = c2_b_u.messageID;
  c2_c_y = NULL;
  sf_mex_assign(&c2_c_y, sf_mex_create("y", &c2_c_u, 6, 0U, 0U, 0U, 0), false);
...
const mxArray *sf_c2_Feb16_DLforMLACC_cs_get_eml_resolved_functions_info(void)
{
  const mxArray *c2_nameCaptureInfo = NULL;
  const char * c2_data[4] = {
    "789cc553dd4ac330144e751b7aa10c2fbcf315ac0edc85579bb1ab936d0c374510a95d77468b4d329254e6dec33b1fc2b7f175ecfeb3d852419c07c2e9c7979e"
    "effc0519f5a68110da8fcf767c3e0a686a7b33878a73bf85d64de78d14bfb03ccaadfdb7e0dfe7de6354c248ce4018506845a4073c06d425b00cd36724a02e95",
    "ddd721200e82852fd09f328320846e40a0c1147015c480d4146a0926d4e41bfbe03d772282b82f56e9862a404a7f9e52eacf65f44737bd3ffabd243d43b95748"
    "d053f9ac79eca21d55bdb2d01ba5c44baa2f49ef2045afa8f177a57bc7b65ad64d1d3bf1b4e474d428bbee9fe651d0f02a8f1923248f3ca9ecfd2ff55aa97aeb",
    "fc83f588cfcd5b015c98a214329fbbc26c73e8782e75acd11078bc9b540ab306bdd3b273d91830de6c543136bf77ec986c724f2a6ff9a3cfea66f772d3efe0ff"
    "f47efbee0e53f48a1a8fc7e58059f6892da233f0edc1b5186376b1caa39da19395074ac17f1dff0b40c062e4",
    "" };
  ...
  char_T *c2_identifier)
{
  ...
  c2_b_y = c2_k_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_Feb16_DLforMLACC_cs), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_Feb16_DLforMLACC_cs);
  return c2_b_y;
}
...
/* SFunction Glue Code */
void sf_c2_Feb16_DLforMLACC_cs_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c2_Feb16_DLforMLACC_cs_get_post_codegen_info(void);
mxArray *sf_c2_Feb16_DLforMLACC_cs_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c2_Feb16_DLforMLACC_cs_get_post_codegen_info
      ();
...
mxArray *sf_c2_Feb16_DLforMLACC_cs_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c2_Feb16_DLforMLACC_cs_jit_fallback_info(void)
{
...
mxArray *sf_c2_Feb16_DLforMLACC_cs_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c2_Feb16_DLforMLACC_cs(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c2_Feb16_DLforMLACC_cs\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_Feb16_DLforMLACC_cs_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc2_Feb16_DLforMLACC_csInstanceStruct *chartInstance =
      (SFc2_Feb16_DLforMLACC_csInstanceStruct *)sf_get_chart_instance_ptr(S);
...
static void sf_opaque_initialize_c2_Feb16_DLforMLACC_cs(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_Feb16_DLforMLACC_csInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c2_Feb16_DLforMLACC_cs
    ((SFc2_Feb16_DLforMLACC_csInstanceStruct*) chartInstanceVar);
  initialize_c2_Feb16_DLforMLACC_cs((SFc2_Feb16_DLforMLACC_csInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c2_Feb16_DLforMLACC_cs(void *chartInstanceVar)
{
  enable_c2_Feb16_DLforMLACC_cs((SFc2_Feb16_DLforMLACC_csInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c2_Feb16_DLforMLACC_cs(void *chartInstanceVar)
{
  disable_c2_Feb16_DLforMLACC_cs((SFc2_Feb16_DLforMLACC_csInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c2_Feb16_DLforMLACC_cs(void *chartInstanceVar)
{
  sf_gateway_c2_Feb16_DLforMLACC_cs((SFc2_Feb16_DLforMLACC_csInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c2_Feb16_DLforMLACC_cs(SimStruct*
  S)
{
  return get_sim_state_c2_Feb16_DLforMLACC_cs
    ((SFc2_Feb16_DLforMLACC_csInstanceStruct *)sf_get_chart_instance_ptr(S));/* raw sim ctx */
}

static void sf_opaque_set_sim_state_c2_Feb16_DLforMLACC_cs(SimStruct* S, const
  mxArray *st)
{
  set_sim_state_c2_Feb16_DLforMLACC_cs((SFc2_Feb16_DLforMLACC_csInstanceStruct*)
    sf_get_chart_instance_ptr(S), st);
}

static void sf_opaque_terminate_c2_Feb16_DLforMLACC_cs(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_Feb16_DLforMLACC_csInstanceStruct*) chartInstanceVar
      )->S;
    ...
    finalize_c2_Feb16_DLforMLACC_cs((SFc2_Feb16_DLforMLACC_csInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc2_Feb16_DLforMLACC_cs((SFc2_Feb16_DLforMLACC_csInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_Feb16_DLforMLACC_cs(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_Feb16_DLforMLACC_cs(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(2030663508U));
  ssSetChecksum1(S,(3421152102U));
  ssSetChecksum2(S,(246393823U));
  ssSetChecksum3(S,(2044579268U));
...
static void mdlRTW_c2_Feb16_DLforMLACC_cs(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_Feb16_DLforMLACC_cs(SimStruct *S)
{
  SFc2_Feb16_DLforMLACC_csInstanceStruct *chartInstance;
  chartInstance = (SFc2_Feb16_DLforMLACC_csInstanceStruct *)utMalloc(sizeof
    (SFc2_Feb16_DLforMLACC_csInstanceStruct));
  if (chartInstance==NULL) {
    sf_mex_error_message("Could not allocate memory for chart instance.");
  }

  memset(chartInstance, 0, sizeof(SFc2_Feb16_DLforMLACC_csInstanceStruct));
  chartInstance->chartInfo.chartInstance = chartInstance;
  chartInstance->chartInfo.isEMLChart = 1;
  chartInstance->chartInfo.chartInitialized = 0;
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_Feb16_DLforMLACC_cs;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_Feb16_DLforMLACC_cs;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_Feb16_DLforMLACC_cs;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c2_Feb16_DLforMLACC_cs;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c2_Feb16_DLforMLACC_cs;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_Feb16_DLforMLACC_cs;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_Feb16_DLforMLACC_cs;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_Feb16_DLforMLACC_cs;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_Feb16_DLforMLACC_cs;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_Feb16_DLforMLACC_cs;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_Feb16_DLforMLACC_cs;
  ...
  mdl_start_c2_Feb16_DLforMLACC_cs(chartInstance);
}

void c2_Feb16_DLforMLACC_cs_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_Feb16_DLforMLACC_cs(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_Feb16_DLforMLACC_cs(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_Feb16_DLforMLACC_cs(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_Feb16_DLforMLACC_cs_method_dispatcher.\n"
